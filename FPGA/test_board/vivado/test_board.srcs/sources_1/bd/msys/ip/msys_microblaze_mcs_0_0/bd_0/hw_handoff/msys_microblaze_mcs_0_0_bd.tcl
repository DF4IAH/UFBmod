...
################################################################
# This is a generated script based on design: bd_cf59
#
...
if { $list_projs eq "" } {
   ...
   set_property BOARD_PART trenz.biz:te0712_100_2c:part0:2.0 [current_project]
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name bd_cf59
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_MASK {0x00000000C0004000} \
 ] $dlmb_cntlr
  ...
  set_property -dict [ list \
   CONFIG.C_MASK {0x0000000080004000} \
 ] $ilmb_cntlr
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces microblaze_I/Data] [get_bd_addr_segs dlmb_cntlr/SLMB/Mem] SEG_dlmb_cntlr_Mem
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces microblaze_I/Instruction] [get_bd_addr_segs ilmb_cntlr/SLMB/Mem] SEG_ilmb_cntlr_Mem
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00004000 [get_bd_addr_spaces microblaze_I/Data] [get_bd_addr_segs second_dlmb_cntlr/SLMB/Mem] SEG_second_dlmb_cntlr_Mem
  create_bd_addr_seg -range 0x00001000 -offset 0x00004000 [get_bd_addr_spaces microblaze_I/Instruction] [get_bd_addr_segs second_ilmb_cntlr/SLMB/Mem] SEG_second_ilmb_cntlr_Mem
