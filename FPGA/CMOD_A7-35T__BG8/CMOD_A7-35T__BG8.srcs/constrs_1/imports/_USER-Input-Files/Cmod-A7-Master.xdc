...
set_property DRIVE 4 [get_ports crypto_sda]
...
set_property DRIVE 4 [get_ports RamCEn]
set_property DRIVE 4 [get_ports RamOEn]
set_property DRIVE 4 [get_ports RamWEn]
set_property DRIVE 4 [get_ports uart_rxd_out]
set_property DRIVE 4 [get_ports {MemAdr[18]}]
set_property DRIVE 4 [get_ports {MemAdr[17]}]
set_property DRIVE 4 [get_ports {MemAdr[16]}]
set_property DRIVE 4 [get_ports {MemAdr[15]}]
set_property DRIVE 4 [get_ports {MemAdr[14]}]
set_property DRIVE 4 [get_ports {MemAdr[13]}]
set_property DRIVE 4 [get_ports {MemAdr[12]}]
set_property DRIVE 4 [get_ports {MemAdr[11]}]
set_property DRIVE 4 [get_ports {MemAdr[10]}]
set_property DRIVE 4 [get_ports {MemAdr[9]}]
set_property DRIVE 4 [get_ports {MemAdr[8]}]
set_property DRIVE 4 [get_ports {MemAdr[7]}]
set_property DRIVE 4 [get_ports {MemAdr[6]}]
set_property DRIVE 4 [get_ports {MemAdr[5]}]
set_property DRIVE 4 [get_ports {MemAdr[4]}]
set_property DRIVE 4 [get_ports {MemAdr[3]}]
set_property DRIVE 4 [get_ports {MemAdr[2]}]
set_property DRIVE 4 [get_ports {MemAdr[1]}]
set_property DRIVE 4 [get_ports {MemAdr[0]}]
set_property DRIVE 4 [get_ports {MemDB[7]}]
set_property DRIVE 4 [get_ports {MemDB[6]}]
set_property DRIVE 4 [get_ports {MemDB[5]}]
set_property DRIVE 4 [get_ports {MemDB[4]}]
set_property DRIVE 4 [get_ports {MemDB[3]}]
set_property DRIVE 4 [get_ports {MemDB[2]}]
set_property DRIVE 4 [get_ports {MemDB[1]}]
set_property DRIVE 4 [get_ports {MemDB[0]}]
