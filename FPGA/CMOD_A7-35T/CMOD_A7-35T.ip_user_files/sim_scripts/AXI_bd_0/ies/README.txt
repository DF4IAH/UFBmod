...
#
# Generated by export_simulation on Thu Mar 28 20:51:42 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './AXI_bd_0.sh' script.

./AXI_bd_0.sh -reset_run
...
./AXI_bd_0.sh -noclean_files

For more information on the script, please type './AXI_bd_0.sh -help'.
