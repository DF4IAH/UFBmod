...
simulate()
{
  xsim mcu -key {Behavioral:sim_1:Functional:mcu} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f021.protoinst" -protoinst "protoinst_files/mcu.protoinst" -log simulate.log
}
