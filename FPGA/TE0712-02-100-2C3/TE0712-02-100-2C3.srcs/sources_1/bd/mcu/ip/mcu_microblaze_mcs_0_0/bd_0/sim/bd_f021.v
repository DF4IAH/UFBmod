...
//--------------------------------------------------------------------------------
//Command: generate_target bd_f021.bd
//Design : bd_f021
...
module bd_f021
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > bd_f021 lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_f021_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_f021_ilmb_cntlr_0 ilmb_cntlr
       (.BRAM_Addr_A(ilmb_port_ADDR),
        ...
        .Sl_UE(ilmb_sl_0_UE),
        .Sl_Wait(ilmb_sl_0_WAIT));
  bd_f021_iomodule_0_0 iomodule_0
       (.Clk(Clk1),
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_f021 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_f021_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk1),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
