...
set_input_delay -clock [get_clocks VIRTUAL_clk_64_0_mcu_clk_wiz_0_0] -clock_fall -max -add_delay 6.000 [get_ports ufb_trx_rxd09_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_64_0_mcu_clk_wiz_0_0] -min -add_delay 0.500 [get_ports ufb_trx_rxd09_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_64_0_mcu_clk_wiz_0_0] -max -add_delay 6.000 [get_ports ufb_trx_rxd09_n]
...
set_input_delay -clock [get_clocks VIRTUAL_clk_64_0_mcu_clk_wiz_0_0] -clock_fall -max -add_delay 6.000 [get_ports ufb_trx_rxd09_p]
set_input_delay -clock [get_clocks VIRTUAL_clk_64_0_mcu_clk_wiz_0_0] -min -add_delay 0.500 [get_ports ufb_trx_rxd09_p]
set_input_delay -clock [get_clocks VIRTUAL_clk_64_0_mcu_clk_wiz_0_0] -max -add_delay 6.000 [get_ports ufb_trx_rxd09_p]
...
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -clock_fall -max -add_delay 14.000 [get_ports ufb_trx_rxd09_n]
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -min -add_delay 0.500 [get_ports ufb_trx_rxd09_n]
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -max -add_delay 14.000 [get_ports ufb_trx_rxd09_n]
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -clock_fall -min -add_delay 0.500 [get_ports ufb_trx_rxd09_p]
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -clock_fall -max -add_delay 14.000 [get_ports ufb_trx_rxd09_p]
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -min -add_delay 0.500 [get_ports ufb_trx_rxd09_p]
set_input_delay -clock [get_clocks ufb_trx_rxclk_p] -max -add_delay 14.000 [get_ports ufb_trx_rxd09_p]
...
set_clock_groups -asynchronous -group [get_clocks clk_pll_i] -group [get_clocks clk_32_lvds_out_mcu_clk_wiz_0_0]
set_clock_groups -asynchronous -group [get_clocks clk_32_lvds_in_mcu_clk_wiz_0_0] -group [get_clocks clk_pll_i]
