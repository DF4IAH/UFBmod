...
proc create_hier_cell_TRX_tx_DDS_unit { parentCell nameHier } {
  ...
  connect_bd_net -net PULLDATA_data_count_0 [get_bd_pins data_count] [get_bd_pins PULLDATA/data_count]
...
proc create_hier_cell_TRX_config { parentCell nameHier } {
  ...
  connect_bd_net -net TRX_gpio_xlslice_0to0_resetn_dout_0 [get_bd_pins TRX_resetn] [get_bd_pins TRX_gpio_xlslice_31downto31_resetn_0/Dout]
  connect_bd_net -net TRX_gpio_xlslice_1to1_blankTx_dout_0 [get_bd_pins LVDS_tx_blank] [get_bd_pins TRX_gpio_xlslice_0downto0_blankTx_0/Dout]
  connect_bd_net -net TRX_gpio_xlslice_1to1_rfxmode_dout_0 [get_bd_pins TRX_rfx_mode] [get_bd_pins TRX_gpio_xlslice_30downto30_rfxmode_0/Dout]
  ...
  connect_bd_net -net axi_TRX_gpio_0_gpio_io_o_0 [get_bd_pins TRX_CONFIG_GPIO1_o] [get_bd_pins TRX_gpio_xlslice_0downto0_blankTx_0/Din] [get_bd_pins TRX_gpio_xlslice_30downto30_rfxmode_0/Din] [get_bd_pins TRX_gpio_xlslice_31downto31_resetn_0/Din]
...
proc create_hier_cell_TRX_LVDS { parentCell nameHier } {
  ...
  connect_bd_net -net TRX_rx_rf09_FIFO_generator_0_rd_data_count_0 [get_bd_pins rx09_rd_data_count_CD100_o] [get_bd_pins TRX_rx09_fifo_generator_0/rd_data_count]
  ...
  connect_bd_net -net val1_len1 [get_bd_pins TRX_rx09_fifo_generator_0/rd_en] [get_bd_pins TRX_rx09_fifo_generator_0/wr_en] [get_bd_pins TRX_rx24_fifo_generator_0/rd_en] [get_bd_pins TRX_rx24_fifo_generator_0/wr_en] [get_bd_pins TRX_tx09_fifo_generator_0/rd_en] [get_bd_pins TRX_tx09_fifo_generator_0/wr_en] [get_bd_pins xlconstant_1_len1/dout]
...
proc create_root_design { parentCell } {
  ...
  set TRX_data_count [ create_bd_port -dir O -from 11 -to 0 -type data TRX_data_count ]
  ...
  set TRX_rd_data_count_CD100_o [ create_bd_port -dir O -from 8 -to 0 -type data TRX_rd_data_count_CD100_o ]
  ...
  set TRX_rx09_32bits_CD100 [ create_bd_port -dir O -from 31 -to 0 -type data TRX_rx09_32bits_CD100 ]
  ...
  set TRX_rx24_32bits_CD100 [ create_bd_port -dir O -from 31 -to 0 -type data TRX_rx24_32bits_CD100 ]
  ...
  set mig_7series_0_ui_clk_sync_rst [ create_bd_port -dir I -type rst mig_7series_0_ui_clk_sync_rst ]
  set_property -dict [ list \
  ...
  connect_bd_net -net TRX_ext_reset_0 [get_bd_ports mig_7series_0_ui_clk_sync_rst] [get_bd_pins TRX_proc_sys_reset_0/ext_reset_in] [get_bd_pins TRX_tx_DDS_unit/ui_clk_sync_rst]
  ...
  connect_bd_net -net TRX_rd_data_count_CD100_0 [get_bd_ports TRX_rd_data_count_CD100_o] [get_bd_pins TRX_LVDS/rx09_rd_data_count_CD100_o]
  ...
  connect_bd_net -net TRX_reset_CD100_0 [get_bd_ports rst_mig_7series_0_100M_peripheral_reset] [get_bd_pins TRX_LVDS/reset_CD100_i] [get_bd_pins TRX_rx_FFT_unit/rst_mig_7series_0_100M_peripheral_reset_in]
  ...
  connect_bd_net -net TRX_rx_rf09_32bits_CD100_0 [get_bd_ports TRX_rx09_32bits_CD100] [get_bd_ports TRX_rx09_fifo] [get_bd_pins TRX_LVDS/TRX_rx09_fifo_o]
  ...
  connect_bd_net -net TRX_rx_rf24_FIFO_dout_0 [get_bd_ports TRX_rx24_32bits_CD100] [get_bd_ports TRX_rx24_fifo] [get_bd_pins TRX_LVDS/TRX_rx24_fifo_o]
  ...
  connect_bd_net -net TRX_tx_rf09_DDS_data_count_0 [get_bd_ports TRX_data_count] [get_bd_pins TRX_tx_DDS_unit/data_count]
