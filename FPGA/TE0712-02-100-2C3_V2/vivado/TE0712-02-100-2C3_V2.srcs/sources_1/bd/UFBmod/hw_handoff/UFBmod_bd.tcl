...
################################################################
# This is a generated script based on design: UFBmod
#
...
proc create_hier_cell_UFBmod_rx09_Decoders { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 7 -to 0 decoder_rx09_ch00_remainVal
  create_bd_pin -dir O decoder_rx09_ch00_sql_open
  create_bd_pin -dir O -from 18 -to 0 decoder_rx09_ch00_strength
  create_bd_pin -dir O -from 7 -to 0 decoder_rx09_ch00_u32Count
  ...
  connect_bd_net -net decoder_rx09_ch00_remainVal [get_bd_pins decoder_rx09_ch00_remainVal] [get_bd_pins UFBmod_rx09_Decoder_0/decoder_rx09_ch00_remainVal]
  ...
  connect_bd_net -net decoder_rx09_ch00_u32Count [get_bd_pins decoder_rx09_ch00_u32Count] [get_bd_pins UFBmod_rx09_Decoder_0/decoder_rx09_ch00_u32Count]
...
proc create_hier_cell_Decoder_rx09_to_FIFO { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 7 -to 0 decoder_rx09_ch00_remainVal
  create_bd_pin -dir I -from 18 -to 0 decoder_rx09_ch00_strength
  create_bd_pin -dir I -from 7 -to 0 decoder_rx09_ch00_u32Count
  ...
  connect_bd_net -net data_rx09_c_counter_binary_0_Q [get_bd_pins Decoder_rx09_to_FIFO_0/decoder_rx09_out_len] [get_bd_pins data_rx09_c_counter_binary_0/Q]
  ...
  connect_bd_net -net decoder_rx09_ch00_remainVal_1 [get_bd_pins decoder_rx09_ch00_remainVal] [get_bd_pins Decoder_rx09_to_FIFO_0/decoder_rx09_ch00_remainVal]
  ...
  connect_bd_net -net decoder_rx09_ch00_u32Count_1 [get_bd_pins decoder_rx09_ch00_u32Count] [get_bd_pins Decoder_rx09_to_FIFO_0/decoder_rx09_ch00_u32Count]
  connect_bd_net -net reset_100MHz [get_bd_pins reset_100MHz] [get_bd_pins Decoder_rx09_to_FIFO_0/reset] [get_bd_pins data_rx09_c_counter_binary_0/SCLR] [get_bd_pins data_rx09_fifo_generator_0/rst]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net FFT_rx09_to_Decoder_decoder_rx09_ch00_noise [get_bd_ports decoder_rx09_ch00_noise] [get_bd_pins FFT_rx09_to_Decoder/decoder_rx09_ch00_noise]
  ...
  connect_bd_net -net decoder_rx09_ch00_remainVal [get_bd_pins Decoder_rx09_to_FIFO/decoder_rx09_ch00_remainVal] [get_bd_pins UFBmod_rx09_Decoders/decoder_rx09_ch00_remainVal]
  ...
  connect_bd_net -net decoder_rx09_ch00_u32Count [get_bd_pins Decoder_rx09_to_FIFO/decoder_rx09_ch00_u32Count] [get_bd_pins UFBmod_rx09_Decoders/decoder_rx09_ch00_u32Count]
