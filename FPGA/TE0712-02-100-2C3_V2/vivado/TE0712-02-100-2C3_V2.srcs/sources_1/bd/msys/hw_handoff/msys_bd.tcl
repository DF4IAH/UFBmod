...
# Hierarchical cell: delay_rx24_2174clk
proc create_hier_cell_delay_rx24_2174clk { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_delay_rx24_2174clk() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: c_shift_ram_dly126_2, and set properties
  set c_shift_ram_dly126_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 c_shift_ram_dly126_2 ]
  set_property -dict [ list \
   CONFIG.AsyncInitVal {000} \
   CONFIG.DefaultData {000} \
   CONFIG.Depth {126} \
   ...
   CONFIG.SyncInitVal {000} \
   CONFIG.Width {3} \
 ] $c_shift_ram_dly126_2

  # Create port connections
  connect_bd_net -net D_0 [get_bd_pins D] [get_bd_pins c_shift_ram_dly1024_0/D]
  connect_bd_net -net c_shift_ram_dly1024_0_Q [get_bd_pins c_shift_ram_dly1024_0/Q] [get_bd_pins c_shift_ram_dly1024_1/D]
  connect_bd_net -net c_shift_ram_dly1024_1_Q [get_bd_pins c_shift_ram_dly1024_1/Q] [get_bd_pins c_shift_ram_dly126_2/D]
  connect_bd_net -net c_shift_ram_dly126_3_Q [get_bd_pins Q] [get_bd_pins c_shift_ram_dly126_2/Q]
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_reset [get_bd_pins reset_CD100_i] [get_bd_pins c_shift_ram_dly1024_0/SCLR] [get_bd_pins c_shift_ram_dly1024_1/SCLR] [get_bd_pins c_shift_ram_dly126_2/SCLR]
  connect_bd_net -net s_axi_aclk_CD100 [get_bd_pins s_axi_aclk_CD100_i] [get_bd_pins c_shift_ram_dly1024_0/CLK] [get_bd_pins c_shift_ram_dly1024_1/CLK] [get_bd_pins c_shift_ram_dly126_2/CLK]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: delay_rx09_2174clk
proc create_hier_cell_delay_rx09_2174clk { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_delay_rx09_2174clk() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_TRX_rx_FFT_calc { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 12 -to 0 cordic_rx09_m_tuser_out
  create_bd_pin -dir O cordic_rx09_tvalid_out
  create_bd_pin -dir O -from 12 -to 0 cordic_rx24_m_tuser_out
  ...
  create_bd_pin -dir I -type rst fft24_aresetn_in_0
  create_bd_pin -dir I -from 7 -to 0 fft24_config_tdata_in
  create_bd_pin -dir I fft24_config_tvalid_in
  ...
  create_bd_pin -dir I -from 2 -to 0 -type data premem_rx09_quarterfrm_in
  create_bd_pin -dir I -from 2 -to 0 -type data premem_rx24_quarterfrm_in
  ...
  create_bd_pin -dir O -type intr xfft_rx24_dly3198_event_data_in_channel_halt_out
  create_bd_pin -dir O -type intr xfft_rx24_dly3198_event_tlast_missing_out
  create_bd_pin -dir O -type intr xfft_rx24_dly3198_event_tlast_unexpected_out
  create_bd_pin -dir O -type intr xfft_rx24_dly3449_event_frame_started_out
  ...
  set_property -dict [ list \
   ...
   CONFIG.cartesian_tuser_width {13} \
  ...
  # Create instance: cordic_rx24_addra_xlslice_9to0, and set properties
  set cordic_rx24_addra_xlslice_9to0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 cordic_rx24_addra_xlslice_9to0 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {9} \
   CONFIG.DIN_WIDTH {16} \
   CONFIG.DOUT_WIDTH {10} \
  ...
  # Create instance: cordic_rx24_xlconcat_0, and set properties
  ...
  # Create instance: delay_rx09_2174clk
  create_hier_cell_delay_rx09_2174clk $hier_obj delay_rx09_2174clk

  # Create instance: delay_rx24_2174clk
  create_hier_cell_delay_rx24_2174clk $hier_obj delay_rx24_2174clk
  ...
  connect_bd_net -net delay_rx09_3198clk_Q [get_bd_pins cordic_rx09_xlconcat_0/In1] [get_bd_pins delay_rx09_2174clk/Q]
  connect_bd_net -net delay_rx24_3198clk_Q [get_bd_pins cordic_rx24_xlconcat_0/In1] [get_bd_pins delay_rx24_2174clk/Q]
  connect_bd_net -net fft09_aresetn_in_0 [get_bd_pins fft09_aresetn_in] [get_bd_pins cordic_rx09/aresetn] [get_bd_pins xfft_rx09_dly3198/aresetn]
  connect_bd_net -net fft09_config_tdata_in_0 [get_bd_pins fft09_config_tdata_in] [get_bd_pins xfft_rx09_dly3198/s_axis_config_tdata]
  connect_bd_net -net fft09_config_tvalid_in_0 [get_bd_pins fft09_config_tvalid_in] [get_bd_pins xfft_rx09_dly3198/s_axis_config_tvalid]
  connect_bd_net -net fft09_data_tlast_in_0 [get_bd_pins fft09_data_tlast_in] [get_bd_pins xfft_rx09_dly3198/s_axis_data_tlast]
  connect_bd_net -net fft09_data_tready_out_0 [get_bd_pins fft09_data_tready_out] [get_bd_pins xfft_rx09_dly3198/s_axis_data_tready]
  connect_bd_net -net fft09_data_tvalid_in_0 [get_bd_pins fft09_data_tvalid_in] [get_bd_pins xfft_rx09_dly3198/s_axis_data_tvalid]
  connect_bd_net -net fft09_s_data_xlconcat_0_dout [get_bd_pins fft_rx09_s_data_xlconcat_0/dout] [get_bd_pins xfft_rx09_dly3198/s_axis_data_tdata]
  connect_bd_net -net fft24_aresetn_in_0 [get_bd_pins fft24_aresetn_in_0] [get_bd_pins cordic_rx24/aresetn] [get_bd_pins xfft_rx24_dly3198/aresetn]
  connect_bd_net -net fft24_config_tdata_in_0 [get_bd_pins fft24_config_tdata_in] [get_bd_pins xfft_rx24_dly3198/s_axis_config_tdata]
  connect_bd_net -net fft24_config_tvalid_in_0 [get_bd_pins fft24_config_tvalid_in] [get_bd_pins xfft_rx24_dly3198/s_axis_config_tvalid]
  connect_bd_net -net fft24_data_tlast_in_0 [get_bd_pins fft24_data_tlast_in] [get_bd_pins xfft_rx24_dly3198/s_axis_data_tlast]
  connect_bd_net -net fft24_data_tready_out_0 [get_bd_pins fft24_data_tready_out] [get_bd_pins xfft_rx24_dly3198/s_axis_data_tready]
  connect_bd_net -net fft24_data_tvalid_in_0 [get_bd_pins fft24_data_tvalid_in] [get_bd_pins xfft_rx24_dly3198/s_axis_data_tvalid]
  connect_bd_net -net fft24_s_data_xlconcat_0_dout [get_bd_pins fft_rx24_s_data_xlconcat_0/dout] [get_bd_pins xfft_rx24_dly3198/s_axis_data_tdata]
  ...
  connect_bd_net -net premem_rx09_quarterfrm_in_0 [get_bd_pins premem_rx09_quarterfrm_in] [get_bd_pins delay_rx09_2174clk/D]
  connect_bd_net -net premem_rx24_quarterfrm_in_0 [get_bd_pins premem_rx24_quarterfrm_in] [get_bd_pins delay_rx24_2174clk/D]
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_reset_0 [get_bd_pins rst_mig_7series_0_100M_peripheral_reset_in] [get_bd_pins delay_rx09_2174clk/reset_CD100_i] [get_bd_pins delay_rx24_2174clk/reset_CD100_i]
  ...
  connect_bd_net -net s_axi_aclk_CD100_0 [get_bd_pins s_axi_aclk_CD100_in] [get_bd_pins cordic_rx09/aclk] [get_bd_pins cordic_rx24/aclk] [get_bd_pins delay_rx09_2174clk/s_axi_aclk_CD100_i] [get_bd_pins delay_rx24_2174clk/s_axi_aclk_CD100_i] [get_bd_pins xfft_rx09_dly3198/aclk] [get_bd_pins xfft_rx24_dly3198/aclk]
  ...
  connect_bd_net -net xfft_rx09_dly3198_m_axis_data_tuser [get_bd_pins cordic_rx09_addra_xlslice_9to0/Din] [get_bd_pins xfft_rx09_dly3198/m_axis_data_tuser]
  connect_bd_net -net xfft_rx09_dly3449_event_data_in_channel_halt_out_0 [get_bd_pins xfft_rx09_dly3449_event_data_in_channel_halt_out] [get_bd_pins xfft_rx09_dly3198/event_data_in_channel_halt]
  connect_bd_net -net xfft_rx09_dly3449_event_frame_started_out_0 [get_bd_pins xfft_rx09_dly3449_event_frame_started_out] [get_bd_pins xfft_rx09_dly3198/event_frame_started]
  connect_bd_net -net xfft_rx09_dly3449_event_tlast_missing_out_0 [get_bd_pins xfft_rx09_dly3449_event_tlast_missing_out] [get_bd_pins xfft_rx09_dly3198/event_tlast_missing]
  connect_bd_net -net xfft_rx09_dly3449_event_tlast_unexpected_out_0 [get_bd_pins xfft_rx09_dly3449_event_tlast_unexpected_out] [get_bd_pins xfft_rx09_dly3198/event_tlast_unexpected]
  connect_bd_net -net xfft_rx24_dly3198_event_data_in_channel_halt_out_0 [get_bd_pins xfft_rx24_dly3198_event_data_in_channel_halt_out] [get_bd_pins xfft_rx24_dly3198/event_data_in_channel_halt]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_missing_out_0 [get_bd_pins xfft_rx24_dly3198_event_tlast_missing_out] [get_bd_pins xfft_rx24_dly3198/event_tlast_missing]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_unexpected_out_0 [get_bd_pins xfft_rx24_dly3198_event_tlast_unexpected_out] [get_bd_pins xfft_rx24_dly3198/event_tlast_unexpected]
  ...
  connect_bd_net -net xfft_rx24_dly3198_m_axis_data_tuser [get_bd_pins cordic_rx24_addra_xlslice_9to0/Din] [get_bd_pins xfft_rx24_dly3198/m_axis_data_tuser]
  ...
  connect_bd_net -net xfft_rx24_dly3449_event_frame_started_out_0 [get_bd_pins xfft_rx24_dly3449_event_frame_started_out] [get_bd_pins xfft_rx24_dly3198/event_frame_started]
...
proc create_hier_cell_TRX_tx_concat { parentCell nameHier } {
  ...
  # Create instance: TRX_tx_xlconcat_0, and set properties
  set TRX_tx_xlconcat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 TRX_tx_xlconcat_0 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {16} \
 ] $TRX_tx_xlconcat_0
  ...
  # Create port connections
  connect_bd_net -net TRX_tx09_fifo_din_0 [get_bd_pins TRX_tx09_fifo_din] [get_bd_pins xlconcat_0/dout]
  ...
  connect_bd_net -net TRX_tx_PTT_in_0 [get_bd_pins TRX_tx_PTT_in] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net TRX_tx_data_out_from_device_in_0 [get_bd_pins TRX_tx_data_out_from_device_in] [get_bd_pins TRX_tx_xlconcat_0/dout]
  connect_bd_net -net TRX_tx_im_out_0 [get_bd_pins TRX_tx_im_out] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net TRX_tx_re_out_0 [get_bd_pins TRX_tx_re_out] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net xlconstant_0_len1_dout [get_bd_pins TRX_tx_xlconcat_0/In1] [get_bd_pins TRX_tx_xlconcat_0/In3] [get_bd_pins TRX_tx_xlconcat_0/In5] [get_bd_pins TRX_tx_xlconcat_0/In7] [get_bd_pins TRX_tx_xlconcat_0/In9] [get_bd_pins TRX_tx_xlconcat_0/In11] [get_bd_pins TRX_tx_xlconcat_0/In13] [get_bd_pins TRX_tx_xlconcat_0/In15] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In3] [get_bd_pins xlconcat_0/In6] [get_bd_pins xlconstant_0_len1/dout]
  connect_bd_net -net xlconstant_1_len1_dout [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In7] [get_bd_pins xlconstant_1_len1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins TRX_tx_xlconcat_0/In0] [get_bd_pins xlslice_00to00/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins TRX_tx_xlconcat_0/In2] [get_bd_pins xlslice_01to01/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins TRX_tx_xlconcat_0/In4] [get_bd_pins xlslice_02to02/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins TRX_tx_xlconcat_0/In6] [get_bd_pins xlslice_03to03/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins TRX_tx_xlconcat_0/In8] [get_bd_pins xlslice_04to04/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins TRX_tx_xlconcat_0/In10] [get_bd_pins xlslice_05to05/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins TRX_tx_xlconcat_0/In12] [get_bd_pins xlslice_06to06/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins TRX_tx_xlconcat_0/In14] [get_bd_pins xlslice_07to07/Dout]
...
proc create_hier_cell_TRX_tx_DDS_unit { parentCell nameHier } {
  ...
  # Create instance: TRX_CDC_tx0_c_shift_ram_0, and set properties
  set TRX_CDC_tx0_c_shift_ram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 TRX_CDC_tx0_c_shift_ram_0 ]
  set_property -dict [ list \
   ...
   CONFIG.Width {32} \
 ] $TRX_CDC_tx0_c_shift_ram_0

  # Create instance: TRX_CDC_tx1_c_shift_ram_0, and set properties
  set TRX_CDC_tx1_c_shift_ram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 TRX_CDC_tx1_c_shift_ram_0 ]
  set_property -dict [ list \
   CONFIG.AsyncInitVal {00000000000000000000000000000000} \
   CONFIG.DefaultData {00000000000000000000000000000000} \
   CONFIG.Depth {1} \
  ...
  # Create instance: TRX_tx0_xlslice_23to00, and set properties
  set TRX_tx0_xlslice_23to00 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TRX_tx0_xlslice_23to00 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {23} \
   CONFIG.DOUT_WIDTH {24} \
 ] $TRX_tx0_xlslice_23to00

  # Create instance: TRX_tx0_xlslice_31to24, and set properties
  set TRX_tx0_xlslice_31to24 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TRX_tx0_xlslice_31to24 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {24} \
   CONFIG.DOUT_WIDTH {8} \
 ] $TRX_tx0_xlslice_31to24
  ...
  # Create instance: TRX_tx1_xlslice_23to00, and set properties
  set TRX_tx1_xlslice_23to00 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TRX_tx1_xlslice_23to00 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {23} \
   CONFIG.DOUT_WIDTH {24} \
 ] $TRX_tx1_xlslice_23to00

  # Create instance: TRX_tx1_xlslice_31to24, and set properties
  set TRX_tx1_xlslice_31to24 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TRX_tx1_xlslice_31to24 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {24} \
   CONFIG.DOUT_WIDTH {8} \
 ] $TRX_tx1_xlslice_31to24
  ...
  # Create instance: TRX_tx_axi_gpio_0, and set properties
  set TRX_tx_axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 TRX_tx_axi_gpio_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins TRX_tx_axi_gpio_0/S_AXI]

  # Create port connections
  connect_bd_net -net SCLR_1 [get_bd_pins SCLR] [get_bd_pins TRX_CDC_tx0_c_shift_ram_0/SCLR] [get_bd_pins TRX_CDC_tx1_c_shift_ram_0/SCLR] [get_bd_pins TRX_tx0_im_xbip_multadd_0/SCLR] [get_bd_pins TRX_tx0_re_xbip_multadd_0/SCLR] [get_bd_pins TRX_tx1_im_xbip_multadd_0/SCLR] [get_bd_pins TRX_tx1_re_xbip_multadd_0/SCLR] [get_bd_pins TRX_tx_4to1_c_counter_binary_0/SCLR]
  connect_bd_net -net TRX_tx0_c_shift_ram_0_Q [get_bd_pins TRX_CDC_tx0_c_shift_ram_0/Q] [get_bd_pins TRX_tx0_xlslice_23to00/Din] [get_bd_pins TRX_tx0_xlslice_31to24/Din]
  ...
  connect_bd_net -net TRX_tx0_xlslice_23to00_Dout [get_bd_pins TRX_tx0_dds_compiler_0/s_axis_config_tdata] [get_bd_pins TRX_tx0_xlslice_23to00/Dout]
  connect_bd_net -net TRX_tx0_xlslice_31to24_Dout [get_bd_pins TRX_tx0_im_xbip_multadd_0/B] [get_bd_pins TRX_tx0_re_xbip_multadd_0/B] [get_bd_pins TRX_tx0_xlslice_31to24/Dout]
  connect_bd_net -net TRX_tx1_c_shift_ram_0_Q [get_bd_pins TRX_CDC_tx1_c_shift_ram_0/Q] [get_bd_pins TRX_tx1_xlslice_23to00/Din] [get_bd_pins TRX_tx1_xlslice_31to24/Din]
  ...
  connect_bd_net -net TRX_tx1_xlslice_23to00_Dout [get_bd_pins TRX_tx1_dds_compiler_0/s_axis_config_tdata] [get_bd_pins TRX_tx1_xlslice_23to00/Dout]
  connect_bd_net -net TRX_tx1_xlslice_31to24_Dout [get_bd_pins TRX_tx1_im_xbip_multadd_0/B] [get_bd_pins TRX_tx1_re_xbip_multadd_0/B] [get_bd_pins TRX_tx1_xlslice_31to24/Dout]
  ...
  connect_bd_net -net TRX_tx_axi_gpio_0_gpio2_io_o [get_bd_pins TRX_CDC_tx1_c_shift_ram_0/D] [get_bd_pins TRX_tx_axi_gpio_0/gpio2_io_o]
  connect_bd_net -net TRX_tx_axi_gpio_0_gpio_io_o [get_bd_pins TRX_CDC_tx0_c_shift_ram_0/D] [get_bd_pins TRX_tx_axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net clk_div_out_1 [get_bd_pins clk_div_out] [get_bd_pins TRX_CDC_tx0_c_shift_ram_0/CLK] [get_bd_pins TRX_CDC_tx1_c_shift_ram_0/CLK] [get_bd_pins TRX_tx0_dds_compiler_0/aclk] [get_bd_pins TRX_tx0_im_xbip_multadd_0/CLK] [get_bd_pins TRX_tx0_re_xbip_multadd_0/CLK] [get_bd_pins TRX_tx1_dds_compiler_0/aclk] [get_bd_pins TRX_tx1_im_xbip_multadd_0/CLK] [get_bd_pins TRX_tx1_re_xbip_multadd_0/CLK] [get_bd_pins TRX_tx_4to1_c_counter_binary_0/CLK]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins TRX_tx_axi_gpio_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins TRX_tx_axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net xlconstant_0_len1_dout [get_bd_pins TRX_tx0_im_xbip_multadd_0/C] [get_bd_pins TRX_tx0_im_xbip_multadd_0/SUBTRACT] [get_bd_pins TRX_tx0_re_xbip_multadd_0/C] [get_bd_pins TRX_tx0_re_xbip_multadd_0/SUBTRACT] [get_bd_pins TRX_tx1_im_xbip_multadd_0/SUBTRACT] [get_bd_pins TRX_tx1_re_xbip_multadd_0/SUBTRACT] [get_bd_pins xlconstant_0_len1/dout]
  connect_bd_net -net xlconstant_1_len1_dout [get_bd_pins TRX_tx0_im_xbip_multadd_0/CE] [get_bd_pins TRX_tx0_re_xbip_multadd_0/CE] [get_bd_pins TRX_tx1_im_xbip_multadd_0/CE] [get_bd_pins TRX_tx1_re_xbip_multadd_0/CE] [get_bd_pins xlconstant_1_len1/dout]
...
proc create_hier_cell_TRX_rx_FFT_unit { parentCell nameHier } {
  ...
  create_bd_pin -dir O fft09_data_tready_out
  create_bd_pin -dir I fft09_data_tvalid_in
  create_bd_pin -dir I -type rst fft24_aresetn_in
  create_bd_pin -dir I -from 7 -to 0 fft24_config_tdata_in
  create_bd_pin -dir I fft24_config_tvalid_in
  create_bd_pin -dir I fft24_data_tlast_in
  create_bd_pin -dir O fft24_data_tready_out
  ...
  create_bd_pin -dir I -from 10 -to 0 premem_rx24_addrb_in
  ...
  connect_bd_net -net cordic_rx09_m_tuser_out_0 [get_bd_pins TRX_rx_FFT_calc/cordic_rx09_m_tuser_out] [get_bd_pins post_fft_rx09_blk_mem_gen_0/addra]
  ...
  connect_bd_net -net fft24_aresetn_in [get_bd_pins fft24_aresetn_in] [get_bd_pins TRX_rx_FFT_calc/fft24_aresetn_in_0]
  connect_bd_net -net fft24_config_tdata_in_0 [get_bd_pins fft24_config_tdata_in] [get_bd_pins TRX_rx_FFT_calc/fft24_config_tdata_in]
  connect_bd_net -net fft24_config_tvalid_in_0 [get_bd_pins fft24_config_tvalid_in] [get_bd_pins TRX_rx_FFT_calc/fft24_config_tvalid_in]
  connect_bd_net -net fft24_data_tlast_in_0 [get_bd_pins fft24_data_tlast_in] [get_bd_pins TRX_rx_FFT_calc/fft24_data_tlast_in]
  connect_bd_net -net fft24_data_tready_out_0 [get_bd_pins fft24_data_tready_out] [get_bd_pins TRX_rx_FFT_calc/fft24_data_tready_out]
  connect_bd_net -net fft24_data_tvalid_in_0 [get_bd_pins fft24_data_tvalid_in] [get_bd_pins TRX_rx_FFT_calc/fft24_data_tvalid_in]
  ...
  connect_bd_net -net premem_rx09_quarterfrm_in_0 [get_bd_pins premem_rx09_quarterfrm_in] [get_bd_pins TRX_rx_FFT_calc/premem_rx09_quarterfrm_in]
  ...
  connect_bd_net -net premem_rx24_addrb_in_0 [get_bd_pins premem_rx24_addrb_in] [get_bd_pins pre_fft_rx24_blk_mem_gen_0/addrb]
  connect_bd_net -net premem_rx24_dina_in_0 [get_bd_pins premem_rx24_dina_in] [get_bd_pins pre_fft_rx24_blk_mem_gen_0/dina]
  connect_bd_net -net premem_rx24_quarterfrm_in_0 [get_bd_pins premem_rx24_quarterfrm_in] [get_bd_pins TRX_rx_FFT_calc/premem_rx24_quarterfrm_in]
  ...
  connect_bd_net -net xfft_rx24_dly3198_event_data_in_channel_halt_out_0 [get_bd_pins xfft_rx24_dly3198_event_data_in_channel_halt_out] [get_bd_pins TRX_rx_FFT_calc/xfft_rx24_dly3198_event_data_in_channel_halt_out]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_missing_out_0 [get_bd_pins xfft_rx24_dly3198_event_tlast_missing_out] [get_bd_pins TRX_rx_FFT_calc/xfft_rx24_dly3198_event_tlast_missing_out]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_unexpected_out_0 [get_bd_pins xfft_rx24_dly3198_event_tlast_unexpected_out] [get_bd_pins TRX_rx_FFT_calc/xfft_rx24_dly3198_event_tlast_unexpected_out]
  connect_bd_net -net xfft_rx24_dly3449_event_frame_started_out_0 [get_bd_pins xfft_rx24_dly3449_event_frame_started_out] [get_bd_pins TRX_rx_FFT_calc/xfft_rx24_dly3449_event_frame_started_out]
...
proc create_hier_cell_TRX_config { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I -from 0 -to 0 -type data scl_i_pll_in
  create_bd_pin -dir O scl_o_pll_out
  create_bd_pin -dir I -from 0 -to 0 -type data sda_i_pll_in
  create_bd_pin -dir O sda_o_pll_out

  # Create instance: CDC_c_shift_ram_0, and set properties
  set CDC_c_shift_ram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 CDC_c_shift_ram_0 ]
  set_property -dict [ list \
  ...
  # Create instance: CDC_c_shift_ram_1, and set properties
  set CDC_c_shift_ram_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 CDC_c_shift_ram_1 ]
  set_property -dict [ list \
   CONFIG.AsyncInitVal {0} \
   CONFIG.DefaultData {0} \
   CONFIG.Depth {2} \
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_iic_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net CDC_c_shift_ram_0_Q [get_bd_pins CDC_c_shift_ram_1/Q] [get_bd_pins axi_iic_0/sda_i]
  connect_bd_net -net CDC_c_shift_ram_0_Q1 [get_bd_pins CDC_c_shift_ram_0/Q] [get_bd_pins axi_iic_0/scl_i]
  ...
  connect_bd_net -net axi_iic_0_scl_t [get_bd_pins axi_iic_0/scl_t] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_iic_0_sda_o [get_bd_pins axi_iic_0/sda_o] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net axi_iic_0_sda_t [get_bd_pins axi_iic_0/sda_t] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins TRX_axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_TRX_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn]
  connect_bd_net -net s_axi_aclk_CD100 [get_bd_pins s_axi_aclk] [get_bd_pins CDC_c_shift_ram_0/CLK] [get_bd_pins CDC_c_shift_ram_1/CLK] [get_bd_pins TRX_axi_quad_spi_0/ext_spi_clk] [get_bd_pins TRX_axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_TRX_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk]
  connect_bd_net -net scl_i_pll [get_bd_pins scl_i_pll_in] [get_bd_pins CDC_c_shift_ram_0/D]
  connect_bd_net -net sda_i_pll [get_bd_pins sda_i_pll_in] [get_bd_pins CDC_c_shift_ram_1/D]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins scl_o_pll_out] [get_bd_pins util_reduced_logic_0/Res]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins sda_o_pll_out] [get_bd_pins util_reduced_logic_1/Res]
...
proc create_hier_cell_TRX_LVDS { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type data TRX_tx_4to1_c_counter_binary_0_THRESH0
  create_bd_pin -dir I -from 0 -to 0 TRX_tx_PTT_in
  ...
  # Create port connections
  connect_bd_net -net TRX_proc_sys_reset_0_peripheral_reset [get_bd_pins rst] [get_bd_pins TRX_rx09_fifo_generator_0/rst] [get_bd_pins TRX_rx24_fifo_generator_0/rst] [get_bd_pins TRX_tx09_fifo_generator_0/rst]
  ...
  connect_bd_net -net TRX_rx_clkdiv_CD016 [get_bd_pins clkdiv_CD016_o] [get_bd_pins TRX_LVDS_selectio_wiz_0/clk_div_out] [get_bd_pins TRX_rx09_fifo_generator_0/wr_clk] [get_bd_pins TRX_rx24_fifo_generator_0/wr_clk] [get_bd_pins TRX_tx09_fifo_generator_0/rd_clk] [get_bd_pins TRX_tx09_fifo_generator_0/wr_clk]
...
proc create_hier_cell_TRX { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I -from 0 -to 0 -type data scl_i_pll_in
  create_bd_pin -dir O -from 0 -to 0 scl_o_pll_out
  create_bd_pin -dir I -from 0 -to 0 -type data sda_i_pll_in
  create_bd_pin -dir O -from 0 -to 0 sda_o_pll_out
  create_bd_pin -dir O -type intr xfft_rx09_dly3449_event_data_in_channel_halt_out
  create_bd_pin -dir O -type intr xfft_rx09_dly3449_event_frame_started_out
  create_bd_pin -dir O -type intr xfft_rx09_dly3449_event_tlast_missing_out
  create_bd_pin -dir O -type intr xfft_rx09_dly3449_event_tlast_unexpected_out
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins TRX_tx_DDS_unit/S_AXI]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins TRX_spi] [get_bd_intf_pins TRX_config/TRX_spi]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI2] [get_bd_intf_pins TRX_config/S_AXI1]
  ...
  connect_bd_net -net TRX_rx_clkdiv_CD016 [get_bd_pins clk_div_out] [get_bd_pins TRX_LVDS/clkdiv_CD016_o] [get_bd_pins TRX_proc_sys_reset_0/slowest_sync_clk] [get_bd_pins TRX_tx_DDS_unit/clk_div_out] [get_bd_pins counter_binary_0/CLK]
  ...
  connect_bd_net -net TRX_tx_4to1_c_counter_binary_0_THRESH0_0 [get_bd_pins TRX_LVDS/TRX_tx_4to1_c_counter_binary_0_THRESH0] [get_bd_pins TRX_tx_DDS_unit/TRX_tx_4to1_c_counter_binary_0_THRESH0]
  connect_bd_net -net TRX_tx_PTT_in_0 [get_bd_pins TRX_tx_PTT_in] [get_bd_pins TRX_LVDS/TRX_tx_PTT_in]
  connect_bd_net -net TRX_tx_im_out_0 [get_bd_pins TRX_LVDS/TRX_tx_im_out] [get_bd_pins TRX_tx_DDS_unit/TRX_tx_im_out]
  connect_bd_net -net TRX_tx_re_out_0 [get_bd_pins TRX_LVDS/TRX_tx_re_out] [get_bd_pins TRX_tx_DDS_unit/TRX_tx_re_out]
  connect_bd_net -net counter_binary_0_THRESH0 [get_bd_pins counter_binary_0/THRESH0] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net fft09_aresetn_in_0 [get_bd_pins fft09_aresetn_in] [get_bd_pins TRX_rx_FFT_unit/fft09_aresetn_in]
  ...
  connect_bd_net -net fft24_aresetn_in_0 [get_bd_pins fft24_aresetn_in] [get_bd_pins TRX_rx_FFT_unit/fft24_aresetn_in]
  connect_bd_net -net fft24_config_tdata_in_0 [get_bd_pins fft24_config_tdata_in] [get_bd_pins TRX_rx_FFT_unit/fft24_config_tdata_in]
  connect_bd_net -net fft24_config_tvalid_in_0 [get_bd_pins fft24_config_tvalid_in] [get_bd_pins TRX_rx_FFT_unit/fft24_config_tvalid_in]
  connect_bd_net -net fft24_data_tlast_in_0 [get_bd_pins fft24_data_tlast_in] [get_bd_pins TRX_rx_FFT_unit/fft24_data_tlast_in]
  connect_bd_net -net fft24_data_tready_out_0 [get_bd_pins fft24_data_tready_out] [get_bd_pins TRX_rx_FFT_unit/fft24_data_tready_out]
  connect_bd_net -net fft24_data_tvalid_in_0 [get_bd_pins fft24_data_tvalid_in] [get_bd_pins TRX_rx_FFT_unit/fft24_data_tvalid_in]
  ...
  connect_bd_net -net premem_rx09_quarterfrm_in_0 [get_bd_pins premem_rx09_quarterfrm_in] [get_bd_pins TRX_rx_FFT_unit/premem_rx09_quarterfrm_in]
  ...
  connect_bd_net -net premem_rx24_addrb_in_0 [get_bd_pins premem_rx24_addrb_in] [get_bd_pins TRX_rx_FFT_unit/premem_rx24_addrb_in]
  connect_bd_net -net premem_rx24_dina_in_0 [get_bd_pins premem_rx24_dina_in] [get_bd_pins TRX_rx_FFT_unit/premem_rx24_dina_in]
  connect_bd_net -net premem_rx24_quarterfrm_in_0 [get_bd_pins premem_rx24_quarterfrm_in] [get_bd_pins TRX_rx_FFT_unit/premem_rx24_quarterfrm_in]
  connect_bd_net -net premem_rx24_wea_in_0 [get_bd_pins premem_rx24_wea_in] [get_bd_pins TRX_rx_FFT_unit/premem_rx24_wea_in]
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn_0 [get_bd_pins s_axi_aresetn] [get_bd_pins TRX_config/s_axi_aresetn] [get_bd_pins TRX_rx_FFT_unit/aresetn_CD100_in] [get_bd_pins TRX_tx_DDS_unit/s_axi_aresetn]
  ...
  connect_bd_net -net s_axi_aclk_CD100_0 [get_bd_pins s_axi_aclk] [get_bd_pins TRX_LVDS/s_axi_aclk] [get_bd_pins TRX_config/s_axi_aclk] [get_bd_pins TRX_rx_FFT_unit/s_axi_aclk_CD100_in] [get_bd_pins TRX_tx_DDS_unit/s_axi_aclk]
  connect_bd_net -net scl_i_pll [get_bd_pins scl_i_pll_in] [get_bd_pins TRX_config/scl_i_pll_in]
  connect_bd_net -net scl_o_pll [get_bd_pins scl_o_pll_out] [get_bd_pins TRX_config/scl_o_pll_out]
  connect_bd_net -net sda_i_pll [get_bd_pins sda_i_pll_in] [get_bd_pins TRX_config/sda_i_pll_in]
  connect_bd_net -net sda_o_pll [get_bd_pins sda_o_pll_out] [get_bd_pins TRX_config/sda_o_pll_out]
  ...
  connect_bd_net -net xfft_rx24_dly3198_event_data_in_channel_halt_out_0 [get_bd_pins xfft_rx24_dly3198_event_data_in_channel_halt_out] [get_bd_pins TRX_rx_FFT_unit/xfft_rx24_dly3198_event_data_in_channel_halt_out]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_unexpected_out_0 [get_bd_pins xfft_rx24_dly3198_event_tlast_unexpected_out] [get_bd_pins TRX_rx_FFT_unit/xfft_rx24_dly3198_event_tlast_unexpected_out]
  connect_bd_net -net xfft_rx24_dly3449_event_frame_started_out_0 [get_bd_pins xfft_rx24_dly3449_event_frame_started_out] [get_bd_pins TRX_rx_FFT_unit/xfft_rx24_dly3449_event_frame_started_out]
...
proc create_hier_cell_BOOT_PLL { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 rst_mig_7series_0_100M_mb_reset_in
  create_bd_pin -dir O -from 0 -to 0 -type data scl_i_pll_out
  create_bd_pin -dir I -from 0 -to 0 scl_o_pll_in
  create_bd_pin -dir O -from 0 -to 0 -type data sda_i_pll_out
  create_bd_pin -dir I -from 0 -to 0 sda_o_pll_in

  # Create instance: BOOT_PLL_CDC_c_shift_ram_0, and set properties
  set BOOT_PLL_CDC_c_shift_ram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 BOOT_PLL_CDC_c_shift_ram_0 ]
  set_property -dict [ list \
   CONFIG.AsyncInitVal {00} \
   CONFIG.DefaultData {00} \
   CONFIG.Depth {2} \
   CONFIG.SyncInitVal {00} \
   CONFIG.Width {2} \
 ] $BOOT_PLL_CDC_c_shift_ram_0

  # Create instance: BOOT_PLL_IIC_xlslice_0downto0_scl, and set properties
  set BOOT_PLL_IIC_xlslice_0downto0_scl [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BOOT_PLL_IIC_xlslice_0downto0_scl ]

  # Create instance: BOOT_PLL_IIC_xlslice_1downto1_sda, and set properties
  set BOOT_PLL_IIC_xlslice_1downto1_sda [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BOOT_PLL_IIC_xlslice_1downto1_sda ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DOUT_WIDTH {1} \
 ] $BOOT_PLL_IIC_xlslice_1downto1_sda
  ...
  # Create instance: BOOT_PLL_util_reduced_logic_0, and set properties
  set BOOT_PLL_util_reduced_logic_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_reduced_logic:2.0 BOOT_PLL_util_reduced_logic_0 ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {or} \
   CONFIG.C_SIZE {2} \
   CONFIG.LOGO_FILE {data/sym_orgate.png} \
 ] $BOOT_PLL_util_reduced_logic_0

  # Create instance: BOOT_PLL_util_reduced_logic_1, and set properties
  set BOOT_PLL_util_reduced_logic_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_reduced_logic:2.0 BOOT_PLL_util_reduced_logic_1 ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {or} \
   CONFIG.C_SIZE {2} \
   CONFIG.LOGO_FILE {data/sym_orgate.png} \
 ] $BOOT_PLL_util_reduced_logic_1

  # Create instance: BOOT_PLL_util_xlconcat_0, and set properties
  set BOOT_PLL_util_xlconcat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 BOOT_PLL_util_xlconcat_0 ]

  # Create instance: BOOT_PLL_util_xlconcat_1, and set properties
  set BOOT_PLL_util_xlconcat_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 BOOT_PLL_util_xlconcat_1 ]

  # Create instance: BOOT_PLL_xlconcat_0, and set properties
  set BOOT_PLL_xlconcat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 BOOT_PLL_xlconcat_0 ]
  set_property -dict [ list \
   CONFIG.IN0_WIDTH {2} \
   CONFIG.IN1_WIDTH {29} \
   CONFIG.IN2_WIDTH {1} \
  ...
  # Create instance: BOOT_PLL_xlconcat_1, and set properties
  set BOOT_PLL_xlconcat_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 BOOT_PLL_xlconcat_1 ]

  # Create instance: BOOT_PLL_xlslice_31downto31, and set properties
  set BOOT_PLL_xlslice_31downto31 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BOOT_PLL_xlslice_31downto31 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {31} \
   CONFIG.DOUT_WIDTH {1} \
 ] $BOOT_PLL_xlslice_31downto31
  ...
  # Create port connections
  connect_bd_net -net BOOT_PLL_CDC_c_shift_ram_0_Q [get_bd_pins BOOT_PLL_CDC_c_shift_ram_0/Q] [get_bd_pins BOOT_PLL_xlconcat_0/In0]
  connect_bd_net -net BOOT_PLL_IIC_xlslice_0downto0_scl_Dout [get_bd_pins scl_i_pll_out] [get_bd_pins BOOT_PLL_IIC_xlslice_0downto0_scl/Dout]
  connect_bd_net -net BOOT_PLL_IIC_xlslice_1downto1_sda_Dout [get_bd_pins sda_i_pll_out] [get_bd_pins BOOT_PLL_IIC_xlslice_1downto1_sda/Dout]
  connect_bd_net -net BOOT_PLL_axi_gpio_0_gpio_io_o [get_bd_pins BOOT_PLL_axi_gpio_0/gpio_io_o] [get_bd_pins BOOT_PLL_xlslice_31downto31/Din]
  ...
  connect_bd_net -net BOOT_PLL_util_reduced_logic_0_Res [get_bd_pins BOOT_PLL_util_reduced_logic_0/Res] [get_bd_pins BOOT_PLL_xlconcat_1/In0]
  connect_bd_net -net BOOT_PLL_util_reduced_logic_1_Res [get_bd_pins BOOT_PLL_util_reduced_logic_1/Res] [get_bd_pins BOOT_PLL_xlconcat_1/In1]
  connect_bd_net -net BOOT_PLL_util_xlconcat_0_dout [get_bd_pins BOOT_PLL_util_reduced_logic_0/Op1] [get_bd_pins BOOT_PLL_util_xlconcat_0/dout]
  connect_bd_net -net BOOT_PLL_util_xlconcat_1_dout [get_bd_pins BOOT_PLL_util_reduced_logic_1/Op1] [get_bd_pins BOOT_PLL_util_xlconcat_1/dout]
  connect_bd_net -net BOOT_PLL_xlconcat_0_dout [get_bd_pins gpio_io_o] [get_bd_pins BOOT_PLL_xlconcat_0/dout]
  connect_bd_net -net BOOT_PLL_xlconcat_1_dout [get_bd_pins BOOT_PLL_CDC_c_shift_ram_0/D] [get_bd_pins BOOT_PLL_xlconcat_1/dout]
  connect_bd_net -net BOOT_PLL_xlslice_31downto31_Dout [get_bd_pins BOOT_PLL_xlconcat_0/In2] [get_bd_pins BOOT_PLL_xlslice_31downto31/Dout]
  ...
  connect_bd_net -net cfgmclk_pll_50MHz [get_bd_pins cfgmclk_pll_50MHz_in] [get_bd_pins BOOT_PLL_CDC_c_shift_ram_0/CLK] [get_bd_pins BOOT_PLL_Local_BRAM/LMB_Clk] [get_bd_pins BOOT_PLL_axi_gpio_0/s_axi_aclk] [get_bd_pins BOOT_PLL_axi_iic_0/s_axi_aclk] [get_bd_pins BOOT_PLL_axi_interconnect_0/ACLK] [get_bd_pins BOOT_PLL_axi_interconnect_0/M00_ACLK] [get_bd_pins BOOT_PLL_axi_interconnect_0/M01_ACLK] [get_bd_pins BOOT_PLL_axi_interconnect_0/S00_ACLK] [get_bd_pins BOOT_PLL_axi_interconnect_0/S01_ACLK] [get_bd_pins BOOT_PLL_microblaze_0/Clk] [get_bd_pins BOOT_PLL_proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net gpio2_io_i_1 [get_bd_pins gpio2_io_i] [get_bd_pins BOOT_PLL_IIC_xlslice_0downto0_scl/Din] [get_bd_pins BOOT_PLL_IIC_xlslice_1downto1_sda/Din] [get_bd_pins BOOT_PLL_axi_gpio_0/gpio2_io_i]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins BOOT_PLL_axi_gpio_0/s_axi_aresetn] [get_bd_pins BOOT_PLL_axi_iic_0/s_axi_aresetn] [get_bd_pins BOOT_PLL_axi_interconnect_0/M00_ARESETN] [get_bd_pins BOOT_PLL_axi_interconnect_0/M01_ARESETN] [get_bd_pins BOOT_PLL_axi_interconnect_0/S00_ARESETN] [get_bd_pins BOOT_PLL_axi_interconnect_0/S01_ARESETN] [get_bd_pins BOOT_PLL_proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net reset_1 [get_bd_pins reset_in] [get_bd_pins BOOT_PLL_proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net rst_mig_7series_0_100M_mb_reset [get_bd_pins rst_mig_7series_0_100M_mb_reset_in] [get_bd_pins BOOT_PLL_util_xlconcat_0/In1] [get_bd_pins BOOT_PLL_util_xlconcat_1/In1]
  connect_bd_net -net scl_o_pll [get_bd_pins scl_o_pll_in] [get_bd_pins BOOT_PLL_util_xlconcat_0/In0]
  connect_bd_net -net sda_o_pll [get_bd_pins sda_o_pll_in] [get_bd_pins BOOT_PLL_util_xlconcat_1/In0]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {rst_100M_peripheral_aresetn} \
  ...
  set fft24_aresetn_in [ create_bd_port -dir I -type rst fft24_aresetn_in ]
  set fft24_config_tdata_in [ create_bd_port -dir I -from 7 -to 0 fft24_config_tdata_in ]
  set fft24_config_tvalid_in [ create_bd_port -dir I fft24_config_tvalid_in ]
  set fft24_data_tlast_in [ create_bd_port -dir I fft24_data_tlast_in ]
  set fft24_data_tready_out [ create_bd_port -dir O fft24_data_tready_out ]
  ...
  set premem_rx09_quarterfrm_in [ create_bd_port -dir I -from 2 -to 0 -type data premem_rx09_quarterfrm_in ]
  ...
  set premem_rx24_addrb_in [ create_bd_port -dir I -from 10 -to 0 premem_rx24_addrb_in ]
  set premem_rx24_dina_in [ create_bd_port -dir I -from 25 -to 0 premem_rx24_dina_in ]
  set premem_rx24_quarterfrm_in [ create_bd_port -dir I -from 2 -to 0 -type data premem_rx24_quarterfrm_in ]
  ...
  set rst_100M_peripheral_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst rst_100M_peripheral_aresetn ]
  ...
  # Create instance: PTT_xlconstant_1_len10, and set properties
  set PTT_xlconstant_1_len10 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 PTT_xlconstant_1_len10 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M18_AXI [get_bd_intf_pins TRX/S_AXI2] [get_bd_intf_pins microblaze_0_axi_periph/M18_AXI]
  ...
  connect_bd_net -net BOOT_PLL_peripheral_aresetn [get_bd_pins BOOT_PLL/peripheral_aresetn] [get_bd_pins mdm_USER2_0/M_AXI_ARESETN]
  ...
  connect_bd_net -net TRX_rx_div_clk_g_0 [get_bd_pins TRX/clk_div_out] [get_bd_pins lt_fmeter_xlconcat_0/In4]
  ...
  connect_bd_net -net cfgmclk_pll_50MHz [get_bd_pins BOOT_PLL/cfgmclk_pll_50MHz_in] [get_bd_pins CFG/cfgmclk_pll_50MHz_out] [get_bd_pins ETH0/cfgmclk_pll_50MHz_in] [get_bd_pins mdm_USER2_0/M_AXI_ACLK] [get_bd_pins vio_0/clk]
  connect_bd_net -net dcm_locked_1 [get_bd_pins CLK1B_CW_0/locked] [get_bd_pins ETH0/dcm_locked_in]
  connect_bd_net -net fft09_aresetn_in_0 [get_bd_ports fft09_aresetn_in] [get_bd_pins TRX/fft09_aresetn_in]
  ...
  connect_bd_net -net fft24_aresetn_in_0 [get_bd_ports fft24_aresetn_in] [get_bd_pins TRX/fft24_aresetn_in]
  connect_bd_net -net fft24_config_tdata_in_0 [get_bd_ports fft24_config_tdata_in] [get_bd_pins TRX/fft24_config_tdata_in]
  connect_bd_net -net fft24_config_tvalid_in_0 [get_bd_ports fft24_config_tvalid_in] [get_bd_pins TRX/fft24_config_tvalid_in]
  connect_bd_net -net fft24_data_tlast_in_0 [get_bd_ports fft24_data_tlast_in] [get_bd_pins TRX/fft24_data_tlast_in]
  connect_bd_net -net fft24_data_tready_out_0 [get_bd_ports fft24_data_tready_out] [get_bd_pins TRX/fft24_data_tready_out]
  connect_bd_net -net fft24_data_tvalid_in_0 [get_bd_ports fft24_data_tvalid_in] [get_bd_pins TRX/fft24_data_tvalid_in]
  ...
  connect_bd_net -net postmem_rx09_doutb_out_0 [get_bd_pins TRX/postmem_rx09_doutb_out] [get_bd_pins vio_0/probe_in22]
  connect_bd_net -net postmem_rx24_doutb_out_0 [get_bd_pins TRX/postmem_rx24_doutb_out] [get_bd_pins vio_0/probe_in23]
  ...
  connect_bd_net -net scl_i_pll [get_bd_pins BOOT_PLL/scl_i_pll_out] [get_bd_pins TRX/scl_i_pll_in]
  connect_bd_net -net scl_o_pll [get_bd_pins BOOT_PLL/scl_o_pll_in] [get_bd_pins TRX/scl_o_pll_out]
  connect_bd_net -net sda_i_pll [get_bd_pins BOOT_PLL/sda_i_pll_out] [get_bd_pins TRX/sda_i_pll_in]
  connect_bd_net -net sda_o_pll [get_bd_pins BOOT_PLL/sda_o_pll_in] [get_bd_pins TRX/sda_o_pll_out]
  ...
  connect_bd_net -net xfft_rx24_dly3198_event_data_in_channel_halt_out_0 [get_bd_pins TRX/xfft_rx24_dly3198_event_data_in_channel_halt_out] [get_bd_pins vio_0/probe_in21]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_missing_out_0 [get_bd_pins TRX/xfft_rx24_dly3198_event_tlast_missing_out] [get_bd_pins vio_0/probe_in20]
  connect_bd_net -net xfft_rx24_dly3198_event_tlast_unexpected_out_0 [get_bd_pins TRX/xfft_rx24_dly3198_event_tlast_unexpected_out] [get_bd_pins vio_0/probe_in19]
  connect_bd_net -net xfft_rx24_dly3449_event_frame_started_out_0 [get_bd_pins TRX/xfft_rx24_dly3449_event_frame_started_out] [get_bd_pins vio_0/probe_in18]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins labtools_fmeter_0/fin] [get_bd_pins lt_fmeter_xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x400F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mdm_USER2_0/Data] [get_bd_addr_segs BOOT_PLL/BOOT_PLL_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x408F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mdm_USER2_0/Data] [get_bd_addr_segs BOOT_PLL/BOOT_PLL_axi_iic_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces mdm_USER2_0/Data_LMB_1] [get_bd_addr_segs microblaze_0_local_memory/dlmb_bram_if_cntlr/SLMB1/Mem] -force
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs CLK1B_CW_0/CLK1B_clk_wiz_0/s_axi_lite/Reg] -force
  ...
  assign_bd_address -offset 0x40040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs SCOPE/SCOPE_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs SCOPE/SCOPE_axi_gpio_1/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs TRX/TRX_tx_DDS_unit/TRX_tx_axi_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs TRX/TRX_config/axi_TRX_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs UART0/axi_UART0_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs CLOCK/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs TRX/TRX_config/axi_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs CFG/CFG_axi_quad_spi_0/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x400F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces BOOT_PLL/BOOT_PLL_microblaze_0/Data] [get_bd_addr_segs BOOT_PLL/BOOT_PLL_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x408F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces BOOT_PLL/BOOT_PLL_microblaze_0/Data] [get_bd_addr_segs BOOT_PLL/BOOT_PLL_axi_iic_0/S_AXI/Reg] -force
