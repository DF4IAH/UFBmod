...
# Hierarchical cell: CFG_Local_BRAM
proc create_hier_cell_CFG_Local_BRAM { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_CFG_Local_BRAM() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net mdm_USER2_0_microblaze_LMB_1_in_1 [get_bd_intf_pins mdm_USER2_0_microblaze_LMB_1_in] [get_bd_intf_pins ilmb_bram_if_cntlr/SLMB2]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins LMB_Clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins dlmb_v10/LMB_Clk] [get_bd_pins ilmb_bram_if_cntlr/LMB_Clk] [get_bd_pins ilmb_v10/LMB_Clk]
...
proc create_hier_cell_ETH0 { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk CFG_Si5338_pll_65MHz_in
  ...
  create_bd_pin -dir O -from 4 -to 0 -type data ETH0_MIIstatus_vio_out
  create_bd_pin -dir O -from 3 -to 0 ETH0_mii_rxd_vio_out
  create_bd_pin -dir O -from 3 -to 0 ETH0_mii_txd_vio_out
  create_bd_pin -dir O -from 3 -to 0 -type data ETH0_status_vio_out
  ...
  # Create port connections
  connect_bd_net -net CFG_Si5338_pll_65MHz_0 [get_bd_pins CFG_Si5338_pll_65MHz_in] [get_bd_pins ETH0_LEDstatus_CDC_c_shift_ram_0/CLK] [get_bd_pins ETH0_MIIstatus_CDC_c_shift_ram_0/CLK] [get_bd_pins ETH0_rxd_CDC_c_shift_ram_0/CLK] [get_bd_pins ETH0_txd_CDC_c_shift_ram_0/CLK]
  ...
  connect_bd_net -net ETH0_LEDstatus_CDC_c_shift_ram_0_Q [get_bd_pins ETH0_status_vio_out] [get_bd_pins ETH0_LEDstatus_CDC_c_shift_ram_0/Q]
  ...
  connect_bd_net -net ETH0_MIIstatus_CDC_c_shift_ram_0_Q [get_bd_pins ETH0_MIIstatus_vio_out] [get_bd_pins ETH0_MIIstatus_CDC_c_shift_ram_0/Q]
  ...
  connect_bd_net -net ETH0_rxd_CDC_c_shift_ram_0_Q [get_bd_pins ETH0_mii_rxd_vio_out] [get_bd_pins ETH0_rxd_CDC_c_shift_ram_0/Q]
  connect_bd_net -net ETH0_txd_CDC_c_shift_ram_0_Q [get_bd_pins ETH0_mii_txd_vio_out] [get_bd_pins ETH0_txd_CDC_c_shift_ram_0/Q]
...
# Hierarchical cell: CFG_Si5338
proc create_hier_cell_CFG_Si5338 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_CFG_Si5338() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir O -type clk CFG_Si5338_clk_wiz_0_65MHz_out
  create_bd_pin -dir O -from 0 -to 0 -type rst CFG_Si5338_interconnect_aresetn
  create_bd_pin -dir O -from 0 -to 0 -type rst CFG_Si5338_peripheral_aresetn
  create_bd_pin -dir O -from 0 -to 0 -type intr CFG_Si5338_qspi_ip2intc_irpt
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DOUT_DEFAULT {0x00000003} \
   CONFIG.C_IS_DUAL {1} \
 ] $CFG_Si5338_axi_gpio_0

  # Create instance: CFG_Si5338_axi_iic_0, and set properties
  set CFG_Si5338_axi_iic_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 CFG_Si5338_axi_iic_0 ]
  set_property -dict [ list \
   CONFIG.IIC_FREQ_KHZ {100} \
 ] $CFG_Si5338_axi_iic_0
  ...
  # Create instance: CFG_Si5338_axi_quad_spi_0, and set properties
  set CFG_Si5338_axi_quad_spi_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 CFG_Si5338_axi_quad_spi_0 ]
  set_property -dict [ list \
   ...
   CONFIG.USE_BOARD_FLOW {true} \
 ] $CFG_Si5338_axi_quad_spi_0

  # Create instance: CFG_Si5338_clk_wiz_0, and set properties
  set CFG_Si5338_clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 CFG_Si5338_clk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {153.84} \
   CONFIG.CLKIN2_JITTER_PS {162.49} \
   CONFIG.CLKOUT1_DRIVES {BUFGCE} \
   CONFIG.CLKOUT1_JITTER {181.383} \
   CONFIG.CLKOUT1_PHASE_ERROR {117.736} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {65} \
   CONFIG.CLKOUT2_DRIVES {BUFGCE} \
   CONFIG.CLKOUT2_JITTER {210.870} \
   CONFIG.CLKOUT2_PHASE_ERROR {117.736} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {32.5} \
   CONFIG.CLKOUT2_USED {true} \
   ...
   CONFIG.CLK_OUT1_PORT {clk_out1_65MHz} \
   CONFIG.CLK_OUT2_PORT {clk_out2_32MHz5} \
   CONFIG.FEEDBACK_SOURCE {FDBK_AUTO} \
   CONFIG.JITTER_SEL {No_Jitter} \
   CONFIG.MMCM_BANDWIDTH {OPTIMIZED} \
   ...
   CONFIG.PLL_CLKIN_PERIOD {15.384} \
 ...
 ] $CFG_Si5338_clk_wiz_0

  # Create instance: CFG_microblaze_0, and set properties
  set CFG_microblaze_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:11.0 CFG_microblaze_0 ]
  set_property -dict [ list \
  ...
  # Create instance: rst_dbg_CFG_Si5338_0_65M_1, and set properties
  set rst_dbg_CFG_Si5338_0_65M_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_dbg_CFG_Si5338_0_65M_1 ]
  set_property -dict [ list \
   CONFIG.C_AUX_RESET_HIGH {0} \
   CONFIG.C_NUM_PERP_RST {1} \
   CONFIG.RESET_BOARD_INTERFACE {reset} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $rst_dbg_CFG_Si5338_0_65M_1

  # Create instance: rst_proc_CFG_Si5338_0_65M, and set properties
  set rst_proc_CFG_Si5338_0_65M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_proc_CFG_Si5338_0_65M ]
  set_property -dict [ list \
   CONFIG.C_AUX_RESET_HIGH {0} \
   CONFIG.C_NUM_PERP_RST {1} \
   CONFIG.RESET_BOARD_INTERFACE {reset} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $rst_proc_CFG_Si5338_0_65M

  # Create interface connections
  connect_bd_intf_net -intf_net AXI_mdm_USER2 [get_bd_intf_pins S01_AXI] [get_bd_intf_pins CFG_Si5338_axi_periph_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net AXI_microblaze_0 [get_bd_intf_pins S02_AXI] [get_bd_intf_pins CFG_Si5338_axi_periph_interconnect_0/S02_AXI]
  connect_bd_intf_net -intf_net BOOT_PLL_axi_iic_0_IIC [get_bd_intf_pins CFG_Si5338_axi_iic_0/IIC] [get_bd_intf_pins SC0712_0/EMIO_I2C]
  connect_bd_intf_net -intf_net BOOT_PLL_axi_periph_interconnect_0_M02_AXI [get_bd_intf_pins CFG_Si5338_axi_periph_interconnect_0/M02_AXI] [get_bd_intf_pins CFG_Si5338_axi_quad_spi_0/AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins CFG_Si5338_axi_iic_0/S_AXI] [get_bd_intf_pins CFG_Si5338_axi_periph_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_pins qspi_flash] [get_bd_intf_pins CFG_Si5338_axi_quad_spi_0/SPI_0]
  ...
  connect_bd_net -net SC0712_0_GPIO1_I [get_bd_pins CFG_Si5338_axi_gpio_0/gpio2_io_i] [get_bd_pins SC0712_0/GPIO1_I]
  ...
  connect_bd_net -net ext_reset_0 [get_bd_pins ext_reset] [get_bd_pins rst_dbg_CFG_Si5338_0_65M_1/ext_reset_in] [get_bd_pins rst_proc_CFG_Si5338_0_65M/ext_reset_in]
  connect_bd_net -net mb_debug_sys_rst_0 [get_bd_pins mb_debug_sys_rst] [get_bd_pins rst_proc_CFG_Si5338_0_65M/mb_debug_sys_rst]
  connect_bd_net -net rst_CFG_0_50M_bus_struct_reset [get_bd_pins CFG_Local_BRAM/SYS_Rst] [get_bd_pins rst_proc_CFG_Si5338_0_65M/bus_struct_reset]
  connect_bd_net -net rst_CFG_0_50M_mb_reset [get_bd_pins CFG_microblaze_0/Reset] [get_bd_pins rst_proc_CFG_Si5338_0_65M/mb_reset]
  connect_bd_net -net rst_dbg_CFG_Si5338_0_65M_1_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins rst_dbg_CFG_Si5338_0_65M_1/interconnect_aresetn]
...
proc create_hier_cell_AXI_TRX { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr TRX_CONFIG_qspi_irpt
  create_bd_pin -dir I -from 31 -to 0 TRX_RX_PUSHDATA_GPIO1_i
  create_bd_pin -dir O -from 31 -to 0 TRX_RX_PUSHDATA_GPIO2_o
  create_bd_pin -dir O -from 0 -to 0 -type intr TRX_RX_PUSHDATA_gpio_irpt
  ...
  connect_bd_net -net TRX_CONFIG_qspi_irpt_0 [get_bd_pins TRX_CONFIG_qspi_irpt] [get_bd_pins TRX_CONFIG_quad_spi_0/ip2intc_irpt]
  ...
  connect_bd_net -net T_RX_RX_PUSHDATA_gpio_irpt_0 [get_bd_pins TRX_RX_PUSHDATA_gpio_irpt] [get_bd_pins TRX_RX_PUSHDATA_axi_gpio_0/ip2intc_irpt]
...
proc create_root_design { parentCell } {
  ...
  set LVDS_mrk09ok [ create_bd_port -dir I LVDS_mrk09ok ]
  set LVDS_mrk24ok [ create_bd_port -dir I LVDS_mrk24ok ]
  ...
  set TRX_rx_rd_data_count [ create_bd_port -dir I -from 3 -to 0 -type data TRX_rx_rd_data_count ]
  ...
  set TRX_tx_data_count [ create_bd_port -dir I -from 11 -to 0 -type data TRX_tx_data_count ]
  ...
  set USER_dbg_00_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_00_signal ]
  set USER_dbg_01_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_01_signal ]
  set USER_dbg_02_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_02_signal ]
  set USER_dbg_03_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_03_signal ]
  set USER_dbg_04_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_04_signal ]
  set USER_dbg_05_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_05_signal ]
  set USER_dbg_06_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_06_signal ]
  set USER_dbg_07_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_07_signal ]
  set USER_dbg_08_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_08_signal ]
  set USER_dbg_09_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_09_signal ]
  set USER_dbg_10_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_10_signal ]
  set USER_dbg_11_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_11_signal ]
  set USER_dbg_12_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_12_signal ]
  set USER_dbg_13_signal [ create_bd_port -dir O -from 0 -to 0 USER_dbg_13_signal ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {rst_mig_7series_0_100M_peripheral_aresetn} \
  ...
  # Create instance: CFG_Si5338
  create_hier_cell_CFG_Si5338 [current_bd_instance .] CFG_Si5338
  ...
  # Create instance: SREC_axi_all_interconnect_0, and set properties
  set SREC_axi_all_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 SREC_axi_all_interconnect_0 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {3} \
 ] $SREC_axi_all_interconnect_0

  # Create instance: SREC_axi_periph_interconnect_0, and set properties
  set SREC_axi_periph_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 SREC_axi_periph_interconnect_0 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {2} \
   CONFIG.NUM_SI {2} \
 ] $SREC_axi_periph_interconnect_0

  # Create instance: SREC_boot_loader_FSM_0, and set properties
  set block_name SREC_boot_loader_FSM
  set block_cell_name SREC_boot_loader_FSM_0
  if { [catch {set SREC_boot_loader_FSM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $SREC_boot_loader_FSM_0 eq "" } {
  ...
  # Create instance: microblaze_0_axi_mem_interconnect_0, and set properties
  set microblaze_0_axi_mem_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 microblaze_0_axi_mem_interconnect_0 ]
  set_property -dict [ list \
   CONFIG.ENABLE_ADVANCED_OPTIONS {0} \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {3} \
 ] $microblaze_0_axi_mem_interconnect_0

  # Create instance: microblaze_0_axi_periph_interconnect_0, and set properties
  set microblaze_0_axi_periph_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 microblaze_0_axi_periph_interconnect_0 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {11} \
   CONFIG.NUM_SI {1} \
 ] $microblaze_0_axi_periph_interconnect_0

  # Create instance: microblaze_0_axi_periph_interconnect_1, and set properties
  set microblaze_0_axi_periph_interconnect_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 microblaze_0_axi_periph_interconnect_1 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {9} \
   CONFIG.NUM_SI {1} \
 ] $microblaze_0_axi_periph_interconnect_1
  ...
  # Create instance: rst_microblaze_0_sys_reset_0, and set properties
  set rst_microblaze_0_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_microblaze_0_sys_reset_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE_OUT0_INIT_VAL {1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AXI_LITE_2 [get_bd_intf_pins AXI_TRX/AXI_LITE] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M06_AXI]
  ...
  connect_bd_intf_net -intf_net CLK0_NA_50M_diff_0 [get_bd_intf_ports CLK0] [get_bd_intf_pins CLK0_util_ds_buf_0/CLK_IN_D]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M00_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net S02_AXI_1 [get_bd_intf_pins CFG_Si5338/S02_AXI] [get_bd_intf_pins SREC_axi_periph_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net SREC_axi_interconnect_0_M00_AXI [get_bd_intf_pins SREC_axi_all_interconnect_0/M00_AXI] [get_bd_intf_pins microblaze_0_local_memory/S_AXI]
  connect_bd_intf_net -intf_net SREC_axi_interconnect_0_M01_AXI [get_bd_intf_pins SREC_axi_all_interconnect_0/M01_AXI] [get_bd_intf_pins microblaze_0_axi_mem_interconnect_0/S02_AXI]
  connect_bd_intf_net -intf_net SREC_axi_interconnect_0_M02_AXI [get_bd_intf_pins SREC_axi_all_interconnect_0/M02_AXI] [get_bd_intf_pins SREC_axi_periph_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net SREC_boot_loader_FSM_0_m00_axi [get_bd_intf_pins SREC_axi_all_interconnect_0/S00_AXI] [get_bd_intf_pins SREC_boot_loader_FSM_0/m00_axi]
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins SCOPE/S_AXI1] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M04_AXI]
  connect_bd_intf_net -intf_net S_AXI1_3 [get_bd_intf_pins AXI_TRX/S_AXI1] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M08_AXI]
  connect_bd_intf_net -intf_net S_AXI2_1 [get_bd_intf_pins AXI_TRX/S_AXI2] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M09_AXI]
  connect_bd_intf_net -intf_net S_AXI3_1 [get_bd_intf_pins AXI_TRX/S_AXI3] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M10_AXI]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins EUI48/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M00_AXI]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins ROTENC_decoder/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M01_AXI]
  connect_bd_intf_net -intf_net S_AXI_3 [get_bd_intf_pins PWM_lights/S_AXI] [get_bd_intf_pins SREC_axi_periph_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net S_AXI_4 [get_bd_intf_pins SCOPE/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M03_AXI]
  connect_bd_intf_net -intf_net S_AXI_7 [get_bd_intf_pins AXI_TRX/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M07_AXI]
  connect_bd_intf_net -intf_net S_AXI_8 [get_bd_intf_pins CLK1B_CW_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M08_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins microblaze_0_axi_mem_interconnect_0/M00_AXI] [get_bd_intf_pins mig_7series_0/S_AXI]
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports qspi_flash] [get_bd_intf_pins CFG_Si5338/qspi_flash]
  connect_bd_intf_net -intf_net mdm_USER2_0_LMB_0 [get_bd_intf_pins CFG_Si5338/mdm_USER2_0_BOOT_LMB_0_in] [get_bd_intf_pins mdm_USER2_0/LMB_0]
  connect_bd_intf_net -intf_net mdm_USER2_0_MBDEBUG_0 [get_bd_intf_pins CFG_Si5338/DEBUG] [get_bd_intf_pins mdm_USER2_0/MBDEBUG_0]
  ...
  connect_bd_intf_net -intf_net mdm_USER2_0_M_AXI [get_bd_intf_pins CFG_Si5338/S01_AXI] [get_bd_intf_pins mdm_USER2_0/M_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DC [get_bd_intf_pins microblaze_0/M_AXI_DC] [get_bd_intf_pins microblaze_0_axi_mem_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_IC [get_bd_intf_pins microblaze_0/M_AXI_IC] [get_bd_intf_pins microblaze_0_axi_mem_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_dp [get_bd_intf_pins microblaze_0/M_AXI_DP] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins ETH0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_0_M01_AXI [get_bd_intf_pins SREC_axi_periph_interconnect_0/S01_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_0_M02_AXI [get_bd_intf_pins INT_ctrl/s_axi] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_0_M03_AXI [get_bd_intf_pins axi_timer_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_0_M04_AXI [get_bd_intf_pins CLOCK/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_1_M02_AXI [get_bd_intf_pins axi_BOARD_iic_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_1_M05_AXI [get_bd_intf_pins UART0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_1_M06_AXI [get_bd_intf_pins UART0/S_AXI1] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_interconnect_1_M07_AXI [get_bd_intf_pins CLK1B_CW_0/s_axi_lite] [get_bd_intf_pins microblaze_0_axi_periph_interconnect_1/M07_AXI]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports DDR3_SDRAM] [get_bd_intf_pins mig_7series_0/DDR3]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins microblaze_0_axi_mem_interconnect_0/ARESETN] [get_bd_pins microblaze_0_local_memory/s_axi_aresetn] [get_bd_pins rst_mig_7series_0_100M/interconnect_aresetn]
  connect_bd_net -net AXI_TRX_TRX_CONFIG_GPIO1_0 [get_bd_ports TRX_CONFIG_GPIO1_o] [get_bd_pins AXI_TRX/TRX_CONFIG_GPIO1_o]
  connect_bd_net -net AXI_TRX_TRX_RX_PUSHDATA_GPIO2_0 [get_bd_ports TRX_RX_PUSHDATA_GPIO2_o] [get_bd_pins AXI_TRX/TRX_RX_PUSHDATA_GPIO2_o]
  connect_bd_net -net AXI_TRX_TRX_RX_PUSHDATA_gpio_irpt [get_bd_pins AXI_TRX/TRX_RX_PUSHDATA_gpio_irpt] [get_bd_pins INT_ctrl/In11]
  connect_bd_net -net AXI_TRX_TRX_TX_DDSAMPL_GPIO1_0 [get_bd_ports TRX_TX_DDSAMPL_GPIO1_o] [get_bd_pins AXI_TRX/TRX_TX_DDSAMPL_GPIO1_o]
  ...
  connect_bd_net -net CFG_Si5338_clk_wiz_0_65MHz_1 [get_bd_pins CFG_Si5338/CFG_Si5338_clk_wiz_0_65MHz_out] [get_bd_pins ETH0/CFG_Si5338_pll_65MHz_in] [get_bd_pins SREC_axi_periph_interconnect_0/M00_ACLK] [get_bd_pins labtools_fmeter_0/refclk] [get_bd_pins mdm_USER2_0/M_AXI_ACLK] [get_bd_pins vio_0/clk]
  ...
  connect_bd_net -net CFG_mon_GPIO1_O [get_bd_pins CFG_Si5338/mon_GPIO1_O] [get_bd_pins vio_0/probe_in6]
  connect_bd_net -net CLK0_NA_50M_0 [get_bd_pins CLK0_util_ds_buf_0/IBUF_OUT] [get_bd_pins CLK0_util_ds_buf_1/BUFG_I]
  connect_bd_net -net CLK0_NA_50M_g_0 [get_bd_pins CLK0_util_ds_buf_1/BUFG_O] [get_bd_pins CLOCK/CLK] [get_bd_pins lt_fmeter_xlconcat_0/In3]
  ...
  connect_bd_net -net ETH0_LEDstatus_vio_0 [get_bd_pins ETH0/ETH0_status_vio_out] [get_bd_pins vio_0/probe_in20]
  connect_bd_net -net ETH0_LINK_LED_g_0 [get_bd_ports ETH0_LINK_LED_g] [get_bd_pins ETH0/ETH0_LINK_LED_in]
  connect_bd_net -net ETH0_MIIstatus_vio_0 [get_bd_pins ETH0/ETH0_MIIstatus_vio_out] [get_bd_pins vio_0/probe_in21]
  ...
  connect_bd_net -net ETH0_m_mii_txd_vio_0 [get_bd_pins ETH0/ETH0_mii_txd_vio_out] [get_bd_pins vio_0/probe_in23]
  connect_bd_net -net ETH0_mii_rxd_vio_0 [get_bd_pins ETH0/ETH0_mii_rxd_vio_out] [get_bd_pins vio_0/probe_in22]
  ...
  connect_bd_net -net LVDS_mrk09ok_1 [get_bd_ports LVDS_mrk09ok] [get_bd_pins vio_0/probe_in60]
  connect_bd_net -net LVDS_mrk24ok_1 [get_bd_ports LVDS_mrk24ok] [get_bd_pins vio_0/probe_in61]
  connect_bd_net -net Net [get_bd_ports PLL_I2C_ext_sda] [get_bd_pins CFG_Si5338/PLL_I2C_ext_sda]
  connect_bd_net -net PLL_irpt [get_bd_ports PLL_int] [get_bd_pins INT_ctrl/In9]
  ...
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_AXI_Addr_0 [get_bd_pins SREC_boot_loader_FSM_0/DBG_AXI_Addr] [get_bd_pins vio_0/probe_in55]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_AXI_DtaPad [get_bd_pins SREC_boot_loader_FSM_0/DBG_AXI_DtaPad] [get_bd_pins vio_0/probe_in54]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_FSM_out [get_bd_pins SREC_boot_loader_FSM_0/DBG_FSM_out] [get_bd_pins vio_0/probe_in63]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_Adr [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_Adr] [get_bd_pins vio_0/probe_in45]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_00 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_00] [get_bd_pins vio_0/probe_in46]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_01 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_01] [get_bd_pins vio_0/probe_in47]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_02 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_02] [get_bd_pins vio_0/probe_in48]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_03 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_03] [get_bd_pins vio_0/probe_in49]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_04 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_04] [get_bd_pins vio_0/probe_in50]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_05 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_05] [get_bd_pins vio_0/probe_in51]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_06 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_06] [get_bd_pins vio_0/probe_in52]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_07 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_07] [get_bd_pins vio_0/probe_in53]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_08 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_08] [get_bd_pins vio_0/probe_in40]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_09 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_09] [get_bd_pins vio_0/probe_in41]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_10 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_10] [get_bd_pins vio_0/probe_in42]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Flash_RD_11 [get_bd_pins SREC_boot_loader_FSM_0/DBG_Flash_RD_11] [get_bd_pins vio_0/probe_in43]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Sig_NxtLoad_out_0 [get_bd_ports USER_dbg_01_signal] [get_bd_pins SREC_boot_loader_FSM_0/DBG_Sig_NxtLoad_out]
  connect_bd_net -net SREC_boot_loader_FSM_0_DBG_Sig_NxtWrite_out_0 [get_bd_ports USER_dbg_02_signal] [get_bd_pins SREC_boot_loader_FSM_0/DBG_Sig_NxtWrite_out]
  ...
  connect_bd_net -net TRX_CONFIG_qspi_irpt_1 [get_bd_pins AXI_TRX/TRX_CONFIG_qspi_irpt] [get_bd_pins INT_ctrl/In10]
  connect_bd_net -net TRX_LVDS_tx09_fifo_din_1 [get_bd_ports TRX_LVDS_tx09_fifo_din] [get_bd_pins vio_0/probe_in62]
  ...
  connect_bd_net -net TRX_rx_rd_data_count_1 [get_bd_ports TRX_rx_rd_data_count] [get_bd_pins vio_0/probe_in11]
  ...
  connect_bd_net -net TRX_tx_data_count_1 [get_bd_ports TRX_tx_data_count] [get_bd_pins vio_0/probe_in25]
  ...
  connect_bd_net -net UART0_irpt [get_bd_pins INT_ctrl/In1] [get_bd_pins UART0/interrupt]
  ...
  connect_bd_net -net labtools_fmeter_0_F0_microblaze_0_Clk_100MHz [get_bd_pins labtools_fmeter_0/F0] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net labtools_fmeter_0_F1_CLK2_125MHz_mgt [get_bd_pins labtools_fmeter_0/F1] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net labtools_fmeter_0_F2_CLK1B_50MHz_eth [get_bd_pins labtools_fmeter_0/F2] [get_bd_pins vio_0/probe_in2]
  connect_bd_net -net labtools_fmeter_0_F3_CLK0_NA [get_bd_pins labtools_fmeter_0/F3] [get_bd_pins vio_0/probe_in3]
  connect_bd_net -net labtools_fmeter_0_F4_TRX_LVDS_divclk [get_bd_pins labtools_fmeter_0/F4] [get_bd_pins vio_0/probe_in8]
  connect_bd_net -net labtools_fmeter_0_F5_ETH0_s_mii_tx_clk [get_bd_pins labtools_fmeter_0/F5] [get_bd_pins vio_0/probe_in9]
  connect_bd_net -net labtools_fmeter_0_F6_ETH0_s_mii_rx_clk [get_bd_pins labtools_fmeter_0/F6] [get_bd_pins vio_0/probe_in10]
  connect_bd_net -net labtools_fmeter_0_F7_TRX_clk_trx_26MHz [get_bd_pins labtools_fmeter_0/F7] [get_bd_pins vio_0/probe_in14]
  connect_bd_net -net labtools_fmeter_0_F8_TRX_clk_trx_pll_25MHz [get_bd_pins labtools_fmeter_0/F8] [get_bd_pins vio_0/probe_in15]
  connect_bd_net -net labtools_fmeter_0_update [get_bd_pins labtools_fmeter_0/update] [get_bd_pins vio_0/probe_in4]
  connect_bd_net -net lt_fmeter_xlconcat_0_dout [get_bd_pins labtools_fmeter_0/fin] [get_bd_pins lt_fmeter_xlconcat_0/dout]
  connect_bd_net -net mdm_USER2_0_Debug_SYS_Rst_1 [get_bd_pins CFG_Si5338/mb_debug_sys_rst] [get_bd_pins ETH0/mb_debug_sys_rst_in] [get_bd_pins mdm_USER2_0/Debug_SYS_Rst]
  connect_bd_net -net microblaze_0_Clk_100MHz [get_bd_ports microblaze_0_Clk_100MHz] [get_bd_pins AXI_TRX/ext_spi_clk] [get_bd_pins BOARD_clk_wiz_0/clk_in1] [get_bd_pins CLK1B_CW_0/s_axi_aclk] [get_bd_pins CLOCK/s_axi_aclk] [get_bd_pins ETH0/s_axi_aclk_in] [get_bd_pins EUI48/microblaze_0_Clk_100MHz_o] [get_bd_pins INT_ctrl/processor_clk] [get_bd_pins PWM_lights/s_axi_aclk] [get_bd_pins ROTENC_decoder/CLK] [get_bd_pins SCOPE/s_axi_aclk] [get_bd_pins SREC_axi_all_interconnect_0/ACLK] [get_bd_pins SREC_axi_all_interconnect_0/M00_ACLK] [get_bd_pins SREC_axi_all_interconnect_0/M01_ACLK] [get_bd_pins SREC_axi_all_interconnect_0/M02_ACLK] [get_bd_pins SREC_axi_all_interconnect_0/S00_ACLK] [get_bd_pins SREC_axi_periph_interconnect_0/ACLK] [get_bd_pins SREC_axi_periph_interconnect_0/M01_ACLK] [get_bd_pins SREC_axi_periph_interconnect_0/S00_ACLK] [get_bd_pins SREC_axi_periph_interconnect_0/S01_ACLK] [get_bd_pins SREC_boot_loader_FSM_0/m00_axi_aclk] [get_bd_pins UART0/s_axi_aclk] [get_bd_pins axi_BOARD_iic_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins lt_fmeter_xlconcat_0/In0] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_mem_interconnect_0/ACLK] [get_bd_pins microblaze_0_axi_mem_interconnect_0/M00_ACLK] [get_bd_pins microblaze_0_axi_mem_interconnect_0/S00_ACLK] [get_bd_pins microblaze_0_axi_mem_interconnect_0/S01_ACLK] [get_bd_pins microblaze_0_axi_mem_interconnect_0/S02_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M00_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M01_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M02_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M03_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M04_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M05_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M06_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M07_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M08_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M09_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/M10_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_0/S00_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M00_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M01_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M02_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M03_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M04_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M05_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M06_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M07_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/M08_ACLK] [get_bd_pins microblaze_0_axi_periph_interconnect_1/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_microblaze_0_sys_reset_0/slowest_sync_clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_ports mig_7series_0_mmcm_locked] [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins rst_microblaze_0_sys_reset_0/dcm_locked] [get_bd_pins rst_mig_7series_0_100M/dcm_locked]
  ...
  assign_bd_address -offset 0x54040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces SREC_boot_loader_FSM_0/m00_axi] [get_bd_addr_segs PWM_lights/axi_PWM_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x00010000 -range 0x00004000 -target_address_space [get_bd_addr_spaces SREC_boot_loader_FSM_0/m00_axi] [get_bd_addr_segs microblaze_0_local_memory/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SREC_boot_loader_FSM_0/m00_axi] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  ...
  assign_bd_address -offset 0x00010000 -range 0x00004000 -target_address_space [get_bd_addr_spaces mdm_USER2_0/Data_LMB_1] [get_bd_addr_segs microblaze_0_local_memory/ilmb_bram_if_cntlr/SLMB2/Mem] -force
  ...
  assign_bd_address -offset 0x47080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ETH0/ETH0_axi_ethernetlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x54200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs SCOPE/SCOPE_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x54210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs SCOPE/SCOPE_axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x44100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_TRX/TRX_CONFIG_TRX_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x45100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_TRX/TRX_CONFIG_quad_spi_0/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x44110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_TRX/TRX_RX_PUSHDATA_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x44130000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_TRX/TRX_TX_DDS_ampt_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x44120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_TRX/TRX_TX_DDS_inc_axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x56070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_BOARD_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x54020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs EUI48/axi_EUI48_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x54040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PWM_lights/axi_PWM_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x54030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ROTENC_decoder/axi_ROTENC_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x54050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs UART0/axi_UART0_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x53050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs UART0/axi_UART0_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x440B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs CLOCK/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x00010000 -range 0x00004000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs microblaze_0_local_memory/ilmb_bram_if_cntlr/SLMB1/Mem] -force
  ...
  assign_bd_address -offset 0x400A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs INT_ctrl/microblaze_0_axi_intc/S_AXI/Reg] -force
