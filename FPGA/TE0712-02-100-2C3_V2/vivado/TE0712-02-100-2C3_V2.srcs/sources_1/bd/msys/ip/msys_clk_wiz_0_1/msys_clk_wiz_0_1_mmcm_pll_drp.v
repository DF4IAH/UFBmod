...
module msys_clk_wiz_0_1_mmcm_drp
   #(
      //***********************************************************************
  ...
  input [15:0] S2_Filter_2  ,
   ...
   initial begin
      ...
      ram[1]  <= {7'h09, 16'h8000, S1_CLKOUT0_2};
      ram[2]  <= {7'h08, 16'h1000, S1_CLKOUT0_1};
      ...
      ram[12] <= {7'h07, 16'h0000, S1_CLKOUT5_2};//edited
      
      // Store CLKOUT6 divide and phase
      ram[13] <= {7'h12, 16'h1000, S1_CLKOUT6_1};
      ram[14] <= {7'h13, 16'h0000, S1_CLKOUT6_2};//edited
   ...
   if (LOAD) begin 
      ...
      // Store CLKOUT0 divide and phase
      ram[24] <= {7'h09, 16'h8000, S2_CLKOUT0_2};
      ram[25] <= {7'h08, 16'h1000, S2_CLKOUT0_1};
      ...
      ram[35] <= {7'h07, 16'h0000, S2_CLKOUT5_2};//edited 
      
      // Store CLKOUT6 divide and phase
      ram[36] <= {7'h12, 16'h1000, S2_CLKOUT6_1};
      ram[37] <= {7'h13, 16'h0000, S2_CLKOUT6_2};//edited
