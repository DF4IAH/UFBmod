...
-- Command     : write_vhdl -force -mode funcsim -rename_top msys_CLK0_util_ds_buf_0_0 -prefix
--               msys_CLK0_util_ds_buf_0_0_ msys_util_ds_buf_3_0_sim_netlist.vhdl
...
entity msys_CLK0_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of msys_CLK0_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of msys_CLK0_util_ds_buf_0_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of msys_CLK0_util_ds_buf_0_0_util_ds_buf : entity is "BUFG";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of msys_CLK0_util_ds_buf_0_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of msys_CLK0_util_ds_buf_0_0_util_ds_buf : entity is 1;
end msys_CLK0_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of msys_CLK0_util_ds_buf_0_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity msys_CLK0_util_ds_buf_0_0 is
  port (
    BUFG_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFG_O : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of msys_CLK0_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of msys_CLK0_util_ds_buf_0_0 : entity is "msys_util_ds_buf_3_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of msys_CLK0_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of msys_CLK0_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2019.2.1";
end msys_CLK0_util_ds_buf_0_0;

architecture STRUCTURE of msys_CLK0_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 100000000, PHASE 0.000, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN msys_util_ds_buf_3_0_BUFG_O, INSERT_VIP 0";
begin
U0: entity work.msys_CLK0_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
