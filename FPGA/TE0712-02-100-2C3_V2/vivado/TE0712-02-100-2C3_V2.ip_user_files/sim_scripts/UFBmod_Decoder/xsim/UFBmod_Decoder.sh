...
simulate()
{
  xsim UFBmod_Decoder -key {Behavioral:sim_1:Functional:UFBmod_Decoder} -tclbatch cmd.tcl -protoinst "protoinst_files/msys.protoinst" -protoinst "protoinst_files/UFBmod_Encoder.protoinst" -protoinst "protoinst_files/UFBmod_Decoder.protoinst" -log simulate.log
}
