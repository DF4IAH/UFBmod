...
#
# Generated by export_simulation on Wed Oct 21 11:09:50 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './UFBmod_Decoder.sh' script.

./UFBmod_Decoder.sh -reset_run
...
./UFBmod_Decoder.sh -noclean_files

For more information on the script, please type './UFBmod_Decoder.sh -help'.
