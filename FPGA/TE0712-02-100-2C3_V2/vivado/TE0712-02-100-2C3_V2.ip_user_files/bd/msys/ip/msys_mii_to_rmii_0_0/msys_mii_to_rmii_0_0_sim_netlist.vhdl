...
entity msys_mii_to_rmii_0_0_SRL_FIFO is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity msys_mii_to_rmii_0_0_rmii_tx_fixed is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity msys_mii_to_rmii_0_0_rmii_rx_fixed is
  port (
    Reset : out STD_LOGIC;
...
architecture STRUCTURE of msys_mii_to_rmii_0_0_rmii_rx_fixed is
  ...
  signal rmii2Mac_crs_i0 : STD_LOGIC;
...
\RX_100_MBPS.I_SRL_FIFO\: entity work.msys_mii_to_rmii_0_0_SRL_FIFO
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity msys_mii_to_rmii_0_0_mii_to_rmii is
  port (
    rst_n : in STD_LOGIC;
    ref_clk : in STD_LOGIC;
  ...
  attribute C_FAMILY of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "artix7";
  attribute C_FIXED_SPEED : string;
  attribute C_FIXED_SPEED of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "1'b1";
  attribute C_INCLUDE_BUF : integer;
  attribute C_INCLUDE_BUF of msys_mii_to_rmii_0_0_mii_to_rmii : entity is 0;
  ...
  attribute hdl of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "VHDL";
  attribute imp_netlist : string;
  attribute imp_netlist of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "TRUE";
  attribute ip_group : string;
  attribute ip_group of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "LOGICORE";
  attribute iptype : string;
  attribute iptype of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "IP";
  attribute style : string;
  attribute style of msys_mii_to_rmii_0_0_mii_to_rmii : entity is "HDL";
end msys_mii_to_rmii_0_0_mii_to_rmii;

architecture STRUCTURE of msys_mii_to_rmii_0_0_mii_to_rmii is
...
begin
\RMII_FIXED.I_RX\: entity work.msys_mii_to_rmii_0_0_rmii_rx_fixed
     port map (
...
\RMII_FIXED.I_TX\: entity work.msys_mii_to_rmii_0_0_rmii_tx_fixed
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity msys_mii_to_rmii_0_0 is
  port (
    rst_n : in STD_LOGIC;
    ref_clk : in STD_LOGIC;
    mac2rmii_tx_en : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of msys_mii_to_rmii_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of msys_mii_to_rmii_0_0 : entity is "msys_mii_to_rmii_0_0,mii_to_rmii,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of msys_mii_to_rmii_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of msys_mii_to_rmii_0_0 : entity is "mii_to_rmii,Vivado 2019.2.1";
end msys_mii_to_rmii_0_0;

architecture STRUCTURE of msys_mii_to_rmii_0_0 is
  attribute C_FAMILY : string;
  ...
  attribute C_INSTANCE : string;
  attribute C_INSTANCE of U0 : label is "msys_mii_to_rmii_0_0";
  attribute C_SPEED_100 : string;
  ...
  attribute x_interface_parameter of ref_clk : signal is "XIL_INTERFACENAME clock, BOARD.ASSOCIATED_PARAM REF_CLK_BOARD_INTERFACE, FREQ_HZ 50000000, PHASE 0.000, CLK_DOMAIN msys_CLK1B, INSERT_VIP 0";
...
begin
U0: entity work.msys_mii_to_rmii_0_0_mii_to_rmii
     port map (
