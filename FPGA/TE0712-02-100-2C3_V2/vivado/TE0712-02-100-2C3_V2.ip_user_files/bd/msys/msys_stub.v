...
module msys(BOARD_IIC_scl_i, BOARD_IIC_scl_o, 
  BOARD_IIC_scl_t, BOARD_IIC_sda_i, BOARD_IIC_sda_o, BOARD_IIC_sda_t, BOARD_ROTENC_I, 
  BOARD_ROTENC_PUSH, BOARD_ROTENC_Q, CLK0_clk_n, CLK0_clk_p, CLK1B_clk, CLK2_mgt_clk0_clk_n, 
  CLK2_mgt_clk0_clk_p, CLK3_sys_diff_clk_n, CLK3_sys_diff_clk_p, DDR3_SDRAM_addr, 
  DDR3_SDRAM_ba, DDR3_SDRAM_cas_n, DDR3_SDRAM_ck_n, DDR3_SDRAM_ck_p, DDR3_SDRAM_cke, 
  DDR3_SDRAM_cs_n, DDR3_SDRAM_dm, DDR3_SDRAM_dq, DDR3_SDRAM_dqs_n, DDR3_SDRAM_dqs_p, 
  DDR3_SDRAM_odt, DDR3_SDRAM_ras_n, DDR3_SDRAM_reset_n, DDR3_SDRAM_we_n, 
  DDR3_init_calib_complete, ETH0_DA_G, ETH0_DA_Y, ETH0_LINK_LED_g, ETH0_MDIO_MDC_mdc, 
  ETH0_MDIO_MDC_mdio_i, ETH0_MDIO_MDC_mdio_o, ETH0_MDIO_MDC_mdio_t, EUI48_FSM_run, 
  EUI48_FSM_start, EUI48_data, LCD_BL, LCD_rstn, LED_RGB_blue, LED_RGB_green, LED_RGB_red, 
  LVDS_mrk09ok, LVDS_mrk24ok, LVDS_rx09_synced, LVDS_rx24_synced, PLL_I2C_ext_scl_o, 
  PLL_I2C_ext_sda, PLL_int, RMII_PHY_M_0_crs_dv, RMII_PHY_M_0_rxd, RMII_PHY_M_0_tx_en, 
  RMII_PHY_M_0_txd, SCOPE_FSM_FIFO_RdEmpty, SCOPE_FSM_FIFO_RdEn, SCOPE_FSM_FIFO_RdValid, 
