...
set_multicycle_path 2 -setup -from [get_pins {auto_LVDS_rotate_i/rot_in_reg[*]/C}]    -to [get_pins {auto_LVDS_rotate_i/barrel_rot32_i/q_reg[*]/D}]
set_multicycle_path 2 -hold  -from [get_pins {auto_LVDS_rotate_i/rot_in_reg[*]/C}]    -to [get_pins {auto_LVDS_rotate_i/barrel_rot32_i/q_reg[*]/D}]

set_multicycle_path 2 -setup -from [get_pins {auto_LVDS_rotate_i/rot_val_reg[*]*/C}]  -to [get_pins {auto_LVDS_rotate_i/barrel_rot32_i/q_reg[*]/D}]
set_multicycle_path 2 -hold  -from [get_pins {auto_LVDS_rotate_i/rot_val_reg[*]*/C}]  -to [get_pins {auto_LVDS_rotate_i/barrel_rot32_i/q_reg[*]/D}]
