...
set_false_path -from [get_clocks mmcm_clkout0] -to [get_clocks clk_pll_i]
set_false_path -from [get_clocks mmcm_clkout2] -to [get_clocks clk_pll_i]
set_false_path -from [get_clocks {CLK1B[0]}] -to [get_clocks CLK0_clk_p[0]]
set_false_path -from [get_clocks {CLK1B[0]}] -to [get_clocks -of_objects [get_pins msys_i/UART0_clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]]
set_false_path -from [get_clocks msys_i/axi_ethernetlite_0/U0/phy_tx_clk] -to [get_clocks -of_objects [get_pins msys_i/UART0_clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]]
