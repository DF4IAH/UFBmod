...
#CLKS
set_property PACKAGE_PIN R4 [get_ports {CLK1B_clk}]
set_property IOSTANDARD LVCMOS15 [get_ports {CLK1B_clk}]

set_property PACKAGE_PIN K4 [get_ports {CLK0_clk_p}]
set_property IOSTANDARD DIFF_SSTL15 [get_ports {CLK0_clk_p}]
