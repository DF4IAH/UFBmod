...
set_property PACKAGE_PIN AB18 [get_ports {ETH0_DA_Y[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ETH0_DA_Y[0]}]
...
set_property SLEW FAST [get_ports {TRX_spi_ss_io[0]}]
...
set_property OFFCHIP_TERM NONE [get_ports ETH0_DA_Y[0]]
...
set_property OFFCHIP_TERM NONE [get_ports TRX_resetn[0]]
