...
namespace eval ::TE {
  namespace eval UTILS {
    ...
    proc te_msg {vmsg_id  vmsg_sev vmsg_msg} {
      ...
      #last vmsg_nr:
        #TE_INIT 186        -> TE initialization
        #TE_UTIL 157        -> TE utilities
        #TE_EXT 18          -> External
    ...
    #typ: .bit, .elf, .rec, .ub, .bin, .mcs .ltx
   ...
   # puts "----------Test:$typ | [file exists ${baseFolder}/${osPath}/${shortDir}/${appPath}]|${baseFolder}/${osPath}/${shortDir}/${appPath} "
    ...
    proc copy_sw_files {} {
      ...
      foreach app $applications {
        ...
        if {![string match  "executable.elf" ${filenameonly}] && ![string match */resources/* ${app}] && ![string match */qemu/* ${app}] && ![string match "u-boot.elf" ${filenameonly}]  && ![string match "bl31.elf" ${filenameonly}]} {
