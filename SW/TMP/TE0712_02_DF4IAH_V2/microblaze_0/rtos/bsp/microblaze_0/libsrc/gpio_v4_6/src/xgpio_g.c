...
{
	{
		XPAR_AXI_TRX_TRX_CONFIG_TRX_GPIO_0_DEVICE_ID,
		XPAR_AXI_TRX_TRX_CONFIG_TRX_GPIO_0_BASEADDR,
		XPAR_AXI_TRX_TRX_CONFIG_TRX_GPIO_0_INTERRUPT_PRESENT,
		XPAR_AXI_TRX_TRX_CONFIG_TRX_GPIO_0_IS_DUAL
	},
	{
		XPAR_AXI_TRX_TRX_RX_PUSHDATA_AXI_GPIO_0_DEVICE_ID,
		XPAR_AXI_TRX_TRX_RX_PUSHDATA_AXI_GPIO_0_BASEADDR,
		XPAR_AXI_TRX_TRX_RX_PUSHDATA_AXI_GPIO_0_INTERRUPT_PRESENT,
		XPAR_AXI_TRX_TRX_RX_PUSHDATA_AXI_GPIO_0_IS_DUAL
	},
	{
		XPAR_AXI_TRX_TRX_TX_DDS_AMPT_AXI_GPIO_0_DEVICE_ID,
		XPAR_AXI_TRX_TRX_TX_DDS_AMPT_AXI_GPIO_0_BASEADDR,
		XPAR_AXI_TRX_TRX_TX_DDS_AMPT_AXI_GPIO_0_INTERRUPT_PRESENT,
		XPAR_AXI_TRX_TRX_TX_DDS_AMPT_AXI_GPIO_0_IS_DUAL
	},
	{
		XPAR_AXI_TRX_TRX_TX_DDS_INC_AXI_GPIO_0_DEVICE_ID,
		XPAR_AXI_TRX_TRX_TX_DDS_INC_AXI_GPIO_0_BASEADDR,
		XPAR_AXI_TRX_TRX_TX_DDS_INC_AXI_GPIO_0_INTERRUPT_PRESENT,
		XPAR_AXI_TRX_TRX_TX_DDS_INC_AXI_GPIO_0_IS_DUAL
	},
	{
