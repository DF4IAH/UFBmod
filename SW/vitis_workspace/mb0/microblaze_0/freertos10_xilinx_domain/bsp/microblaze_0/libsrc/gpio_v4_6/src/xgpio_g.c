...
XGpio_Config XGpio_ConfigTable[XPAR_XGPIO_NUM_INSTANCES] =
{
	...
	{
		XPAR_TRX_TRX_TX_DDS_UNIT_TRX_TX_AXI_GPIO_0_DEVICE_ID,
		XPAR_TRX_TRX_TX_DDS_UNIT_TRX_TX_AXI_GPIO_0_BASEADDR,
		XPAR_TRX_TRX_TX_DDS_UNIT_TRX_TX_AXI_GPIO_0_INTERRUPT_PRESENT,
		XPAR_TRX_TRX_TX_DDS_UNIT_TRX_TX_AXI_GPIO_0_IS_DUAL
	},
	{
	...
	{
		XPAR_AXI_ONEWIRE_GPIO_0_DEVICE_ID,
		XPAR_AXI_ONEWIRE_GPIO_0_BASEADDR,
		XPAR_AXI_ONEWIRE_GPIO_0_INTERRUPT_PRESENT,
		XPAR_AXI_ONEWIRE_GPIO_0_IS_DUAL
	}
};
