...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = TRX_TRX_tx_DDS_unit_TRX_tx_dds_ampt_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = TRX_TRX_tx_DDS_unit_TRX_tx_dds_inc_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = TRX_TRX_rx_FFT_unit_PUSHDATA_pushdata_rx09_axi_gpio_0
END
